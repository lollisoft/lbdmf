...
public:
		...
		lbErrCodes LB_STDCALL _getServerName(lb_I_Transfer_Data* request, lb_I_Transfer_Data* result);
		lb_I_String* LB_STDCALL getServerName(char* applicationName);
		
		lbErrCodes LB_STDCALL _getServiceName(lb_I_Transfer_Data* request, lb_I_Transfer_Data* result);
