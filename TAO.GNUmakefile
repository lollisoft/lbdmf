...
#       GNU ACE Workspace
#
# $Id: TAO.GNUmakefile,v 1.1.2.2 2025/04/05 16:16:25 lothar Exp $
#
...
.PHONY: AMH_Server
AMH_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging AMH_Idl
	$(KEEP_GOING)@cd DevGuideExamples/AMH && $(MAKE) -f GNUmakefile.AMH_Server all

.PHONY: AMH_Client
AMH_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging AMH_Idl AMH_Server
...
AMH_AMI_Inner_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging AMH_AMI_Idl
	$(KEEP_GOING)@cd DevGuideExamples/AMH_AMI && $(MAKE) -f GNUmakefile.AMH_AMI_Inner_Server all

.PHONY: AMH_AMI_Middle_Server
AMH_AMI_Middle_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging AMH_AMI_Idl AMH_AMI_Inner_Server
...
ServantLocator_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer ServantLocator_Idl
...
ServantLocator_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode ServantLocator_Idl ServantLocator_Server
...
Multithreading_Reactive_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer Reactive_Idl
...
Multithreading_Reactive_Client: TAO_IDL_EXE TAO Codeset Reactive_Idl Multithreading_Reactive_Server
...
Multi_ThreadPerConnection_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer ThreadPerConnection_Idl
...
Multi_ThreadPerConnection_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode ThreadPerConnection_Idl Multi_ThreadPerConnection_Server
...
.PHONY: Auth_Client
Auth_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI Auth_Idl
...
.PHONY: Auth_Server
Auth_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer Auth_Idl Auth_Client PI_Server
...
.PHONY: IOR_Client
IOR_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI IOR_Idl
...
.PHONY: IOR_Server
IOR_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer PI_Server IOR_Idl IOR_Client ObjRefTemplate IORInterceptor
...
PICurrent_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PICurrent_Idl
...
PICurrent_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer PI_Server PICurrent_Idl PICurrent_Client
...
SmartProxies_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging SmartProxies SmartProxies_Server SmartProxies_Logger
...
Bank__Dev_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype PortableServer Bank_Dev_Bank_Idl
	$(KEEP_GOING)@cd DevGuideExamples/ValueTypes/Bank && $(MAKE) -f GNUmakefile.Bank__Dev_Server all

.PHONY: Bank__Dev_Client
Bank__Dev_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype Bank_Dev_Bank_Idl Bank__Dev_Server
...
Quoter_AMI_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging Quoter_AMI_Idl
	$(KEEP_GOING)@cd docs/tutorials/Quoter/AMI && $(MAKE) -f GNUmakefile.Quoter_AMI_Client all

.PHONY: Quoter_AMI_Server
Quoter_AMI_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging Quoter_AMI_Idl Quoter_AMI_Client
...
.PHONY: CosNaming
CosNaming: TAO_IDL_EXE TAO Codeset AnyTypeCode CosNaming_IDL
...
Quoter_Event_Service_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer Quoter_Event_Service_Idl CosNaming CosEvent CosEvent_Skel
...
Quoter_Event_Service_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer Quoter_Event_Service_Idl CosNaming CosEvent CosEvent_Skel Quoter_Event_Service_Server
...
Quoter_Naming_Service_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming Quoter_Idl_Lib
...
Quoter_Naming_Service_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming Quoter_Idl_Lib
...
Quoter_On_Demand_Activation_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming Quoter_On_Demand_Activation_Idl
...
Quoter_On_Demand_Activation_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming Quoter_On_Demand_Activation_Idl Quoter_On_Demand_Activation_Client
...
Quoter_RT_Event_Service_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming Quoter_RT_Event_Service_Idl Svc_Utils RTEvent RTEvent_Skel RTEvent_Serv
...
Quoter_RT_Event_Service_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming Quoter_RT_Event_Service_Idl Svc_Utils RTEvent RTEvent_Skel RTEvent_Serv Quoter_RT_Event_Service_Server
...
Quoter_Simple_Impl_Repo_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming Quoter_Idl_Lib Svc_Utils RTEvent
...
.PHONY: IORTable
IORTable: TAO_IDL_EXE TAO Codeset IORTable_Core_Idl
	$(KEEP_GOING)@cd tao/IORTable && $(MAKE) -f GNUmakefile.IORTable all

.PHONY: Quoter_Simple_Impl_Repo_Server
Quoter_Simple_Impl_Repo_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming Quoter_Idl_Lib Svc_Utils RTEvent IORTable
...
Sink_Server_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging Sink_Server_IDL Strategies
	$(KEEP_GOING)@cd examples/AMH/Sink_Server && $(MAKE) -f GNUmakefile.Sink_Server_Client all

.PHONY: Sink_Server_Mt_Server
Sink_Server_Mt_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging Sink_Server_IDL Strategies Sink_Server_Client
	$(KEEP_GOING)@cd examples/AMH/Sink_Server && $(MAKE) -f GNUmakefile.Sink_Server_Mt_Server all

.PHONY: Sink_Server_St_Server
Sink_Server_St_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging Sink_Server_IDL Strategies Sink_Server_Client Sink_Server_Mt_Server
...
FL_Callback_Peer: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging Strategies FL_Callback_Idl
...
FL_Callback_Progress: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging FL_Callback_Idl FL_Callback_Peer TAO_FlResource
...
Advanced_Ch_18_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode CosNaming Advanced_Ch_18_Idl
...
CSD_Test_ThreadPool_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode CSD_Test_ThreadPool_Idl
...
CSD_Test_ThreadPool_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer CSD_Test_ThreadPool_Idl CSD_Test_ThreadPool_Client CSD_Framework CSD_ThreadPool
...
CSD_Test_ThreadPool2_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer CSD_Framework CSD_ThreadPool CSD_Test_ThreadPool2_Idl
...
CSD_Test_ThreadPool2_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode CSD_Test_ThreadPool2_Idl CSD_Test_ThreadPool2_Server
...
CSD_Test_ThreadPool6_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer CSD_Framework CSD_ThreadPool CSD_Test_ThreadPool6_Idl
...
CSD_Test_ThreadPool6_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode CSD_Test_ThreadPool6_Idl CSD_Test_ThreadPool6_Server
...
Callback_Quoter_notifier: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer CosNaming Callback_Quoter_IDL TAO_Utils
	$(KEEP_GOING)@cd examples/Callback_Quoter && $(MAKE) -f GNUmakefile.Callback_Quoter_notifier all

.PHONY: Callback_Quoter_supplier
Callback_Quoter_supplier: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming Callback_Quoter_IDL Callback_Quoter_notifier
	$(KEEP_GOING)@cd examples/Callback_Quoter && $(MAKE) -f GNUmakefile.Callback_Quoter_supplier all

.PHONY: Callback_Quoter_consumer
Callback_Quoter_consumer: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming Callback_Quoter_IDL Callback_Quoter_notifier Callback_Quoter_supplier
...
AMI_Iterator_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming AMI_Iterator_IDL
	$(KEEP_GOING)@cd examples/Content_Server/AMI_Iterator && $(MAKE) -f GNUmakefile.AMI_Iterator_Client all

.PHONY: AMI_Iterator_Server
AMI_Iterator_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming AMI_Iterator_IDL AMI_Iterator_Client
...
AMI_Observer_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming AMI_Observer_IDL
	$(KEEP_GOING)@cd examples/Content_Server/AMI_Observer && $(MAKE) -f GNUmakefile.AMI_Observer_Server all

.PHONY: AMI_Observer_Client
AMI_Observer_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming AMI_Observer_IDL AMI_Observer_Server
...
SMI_Iterator_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode CosNaming SMI_Iterator_IDL
	$(KEEP_GOING)@cd examples/Content_Server/SMI_Iterator && $(MAKE) -f GNUmakefile.SMI_Iterator_Client all

.PHONY: SMI_Iterator_Server
SMI_Iterator_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming SMI_Iterator_IDL SMI_Iterator_Client
...
Event_Comm_Notifier: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer CosNaming TAO_Utils Event_Comm_IDL
	$(KEEP_GOING)@cd examples/Event_Comm && $(MAKE) -f GNUmakefile.Event_Comm_Notifier all

.PHONY: Event_Comm_Consumer
Event_Comm_Consumer: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming Event_Comm_IDL Event_Comm_Notifier
	$(KEEP_GOING)@cd examples/Event_Comm && $(MAKE) -f GNUmakefile.Event_Comm_Consumer all

.PHONY: Event_Comm_Supplier
Event_Comm_Supplier: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming Event_Comm_IDL Event_Comm_Notifier
...
.PHONY: fp_client
fp_client: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer PI_Server RTCORBA RTScheduler Kokyu_DSRT_Schedulers fp_example_IDL
	$(KEEP_GOING)@cd examples/Kokyu_dsrt_schedulers/fp_example && $(MAKE) -f GNUmakefile.fp_client all

.PHONY: fp_server
fp_server: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer PI_Server RTCORBA RTScheduler Kokyu_DSRT_Schedulers fp_example_IDL fp_client
...
Load_Balancing_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer TAO_Utils Load_Balancing_IDL
	$(KEEP_GOING)@cd examples/Load_Balancing && $(MAKE) -f GNUmakefile.Load_Balancing_Server all

.PHONY: Load_Balancing_Balancer
Load_Balancing_Balancer: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer TAO_Utils Load_Balancing_IDL Load_Balancing_Server
	$(KEEP_GOING)@cd examples/Load_Balancing && $(MAKE) -f GNUmakefile.Load_Balancing_Balancer all

.PHONY: Load_Balancing_Client
Load_Balancing_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer TAO_Utils Load_Balancing_IDL Load_Balancing_Server
...
Load_Balancing_Persistent_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer TAO_Utils Load_Balancing_Persistent_IDL
...
Load_Balancing_Persistent_Balancer: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer TAO_Utils Load_Balancing_Persistent_IDL Load_Balancing_Persistent_Client
...
Load_Balancing_Persistent_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer TAO_Utils Load_Balancing_Persistent_IDL Load_Balancing_Persistent_Client
...
Logging_Service: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer CosNaming TAO_Utils Logging_IDL
	$(KEEP_GOING)@cd examples/Logging && $(MAKE) -f GNUmakefile.Logging_Service all

.PHONY: Logging_Test
Logging_Test: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer CosNaming TAO_Utils Logging_IDL Logging_Service
...
Persistent_Grid_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer TAO_Utils Persistent_Grid_IDL
	$(KEEP_GOING)@cd examples/Persistent_Grid && $(MAKE) -f GNUmakefile.Persistent_Grid_Server all

.PHONY: Persistent_Grid_Client
Persistent_Grid_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer TAO_Utils Persistent_Grid_IDL Persistent_Grid_Server
...
Persistent_Grid_Persistent_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer TAO_Utils Persistent_Grid_IDL Persistent_Grid_Server
...
Performance_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer Strategies Performance_IDL
	$(KEEP_GOING)@cd examples/PluggableUDP/tests/Performance && $(MAKE) -f GNUmakefile.Performance_Server all

.PHONY: Performance_Client
Performance_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer Strategies Performance_IDL Performance_Server
...
.PHONY: CosLifeCycle
CosLifeCycle: TAO_IDL_EXE TAO Codeset AnyTypeCode CosNaming CosLifeCycle_IDL
	$(KEEP_GOING)@cd orbsvcs/orbsvcs && $(MAKE) -f GNUmakefile.CosLifeCycle all

.PHONY: CosLifeCycle_Skel
CosLifeCycle_Skel: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming CosLifeCycle
	$(KEEP_GOING)@cd orbsvcs/orbsvcs && $(MAKE) -f GNUmakefile.CosLifeCycle_Skel all

.PHONY: Quoter_Server
Quoter_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer CosNaming TAO_Utils Quoter_IDL CosLifeCycle CosLifeCycle_Skel
	$(KEEP_GOING)@cd examples/Quoter && $(MAKE) -f GNUmakefile.Quoter_Server all

.PHONY: Quoter_Client
Quoter_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode CosNaming Quoter_IDL CosLifeCycle Quoter_Server
	$(KEEP_GOING)@cd examples/Quoter && $(MAKE) -f GNUmakefile.Quoter_Client all

.PHONY: Quoter_Factory_Finder
Quoter_Factory_Finder: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer CosNaming TAO_Utils Quoter_IDL CosLifeCycle CosLifeCycle_Skel Quoter_Server
	$(KEEP_GOING)@cd examples/Quoter && $(MAKE) -f GNUmakefile.Quoter_Factory_Finder all

.PHONY: Quoter_Generic_Factory
Quoter_Generic_Factory: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer CosNaming TAO_Utils Quoter_IDL CosLifeCycle CosLifeCycle_Skel Quoter_Server
	$(KEEP_GOING)@cd examples/Quoter && $(MAKE) -f GNUmakefile.Quoter_Generic_Factory all

.PHONY: Activity
Activity: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer RTCORBA RTPortableServer CosNaming
...
MIF_Scheduler_Starter: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming RTSchedSynch
...
Fixed_Priority_Scheduler_Starter: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming MIF_Scheduler_Starter
...
RTSchedTestLib: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer PI_Server RTCORBA RTPortableServer CosNaming RTScheduler Job
	$(KEEP_GOING)@cd examples/RTScheduling && $(MAKE) -f GNUmakefile.RTSchedTestLib all

.PHONY: Fixed_Priority_Scheduler_Test
Fixed_Priority_Scheduler_Test: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer PI_Server RTCORBA RTPortableServer CosNaming RTScheduler Fixed_Priority_Scheduler_Starter RTSchedTestLib
...
MIF_Scheduler_Test: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer PI_Server RTCORBA RTPortableServer CosNaming RTScheduler MIF_Scheduler_Starter RTSchedTestLib
...
.PHONY: bank_server
bank_server: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer CosNaming IORTable TAO_Utils bank_IDL
	$(KEEP_GOING)@cd examples/Simple/bank && $(MAKE) -f GNUmakefile.bank_server all

.PHONY: bank_client
bank_client: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer CosNaming IORTable TAO_Utils bank_IDL bank_server
...
.PHONY: echo_server
echo_server: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer CosNaming IORTable TAO_Utils echo_IDL
	$(KEEP_GOING)@cd examples/Simple/echo && $(MAKE) -f GNUmakefile.echo_server all

.PHONY: echo_client
echo_client: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer CosNaming IORTable TAO_Utils echo_IDL echo_server
...
.PHONY: grid_server
grid_server: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer CosNaming IORTable TAO_Utils grid_IDL
	$(KEEP_GOING)@cd examples/Simple/grid && $(MAKE) -f GNUmakefile.grid_server all

.PHONY: grid_client
grid_client: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer CosNaming IORTable TAO_Utils grid_IDL grid_server
...
Simple_Time_Date_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming IORTable Simple_Time_Date_Lib
...
.PHONY: time_server
time_server: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer CosNaming IORTable TAO_Utils time_IDL
	$(KEEP_GOING)@cd examples/Simple/time && $(MAKE) -f GNUmakefile.time_server all

.PHONY: time_client
time_client: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer CosNaming IORTable TAO_Utils time_IDL time_server
...
.PHONY: RTSched
RTSched: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming Svc_Utils
	$(KEEP_GOING)@cd orbsvcs/orbsvcs && $(MAKE) -f GNUmakefile.RTSched all

.PHONY: Event_Supplier_Event_Sup
Event_Supplier_Event_Sup: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming Svc_Utils RTEvent RTEvent_Skel TAO_Utils Event_Supplier_IDL RTSched
...
Event_Supplier_DualEC_Sup: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming Svc_Utils RTEvent RTEvent_Skel RTEvent_Serv TAO_Utils Event_Supplier_IDL RTSched Event_Supplier_Event_Sup
...
Event_Supplier_Event_Con: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming Svc_Utils RTEvent RTEvent_Skel Event_Supplier_IDL RTSched Event_Supplier_Event_Sup
...
Event_Supplier_Logging_Sup: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming Svc_Utils RTEvent RTEvent_Skel TAO_Utils Event_Supplier_IDL RTSched Event_Supplier_Event_Sup
...
ior_corbaloc_client: TAO_IDL_EXE TAO Codeset AnyTypeCode CosNaming ior_corbaloc_IDL
...
ior_corbaloc_server: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming ior_corbaloc_IDL ior_corbaloc_client
	$(KEEP_GOING)@cd examples/ior_corbaloc && $(MAKE) -f GNUmakefile.ior_corbaloc_server all

.PHONY: MFC_Client
MFC_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming
...
Interop_Wchar_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode interop_wchar_IDL
	$(KEEP_GOING)@cd interop-tests/wchar && $(MAKE) -f GNUmakefile.Interop_Wchar_Client all

.PHONY: Interop_Wchar_Server
Interop_Wchar_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer interop_wchar_IDL Interop_Wchar_Client
...
CosConcurrency_Serv: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosConcurrency CosConcurrency_Skel
	$(KEEP_GOING)@cd orbsvcs/orbsvcs && $(MAKE) -f GNUmakefile.CosConcurrency_Serv all

.PHONY: Concurrency_Service
Concurrency_Service: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer CosNaming Svc_Utils TAO_Utils CosConcurrency CosConcurrency_Skel CosConcurrency_Serv
...
.PHONY: CosEvent_Serv
CosEvent_Serv: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming CosEvent CosEvent_Skel Svc_Utils IFR_Client DynamicInterface
	$(KEEP_GOING)@cd orbsvcs/orbsvcs && $(MAKE) -f GNUmakefile.CosEvent_Serv all

.PHONY: CosEvent_Service
CosEvent_Service: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming CosEvent CosEvent_Skel Svc_Utils IORTable IFR_Client DynamicInterface CosEvent_Serv
	$(KEEP_GOING)@cd orbsvcs/CosEvent_Service && $(MAKE) -f GNUmakefile.CosEvent_Service all

.PHONY: OMG_Basic_Consumer
OMG_Basic_Consumer: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming CosEvent CosEvent_Skel
...
OMG_Basic_Supplier: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming CosEvent CosEvent_Skel
...
OMG_SupplierSideEC_Consumer: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming CosEvent CosEvent_Skel
...
OMG_SupplierSideEC_Supplier: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming CosEvent CosEvent_Skel Svc_Utils IFR_Client DynamicInterface CosEvent_Serv
...
OMG_TypedEC_Supplier: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming CosEvent CosEvent_Skel
...
OMG_TypedEC_Consumer: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming CosEvent CosEvent_Skel OMG_TypedEC_Supplier
...
RTEC_Basic_Consumer: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming Svc_Utils RTEvent RTEvent_Skel
...
RTEC_Basic_Supplier: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming Svc_Utils RTEvent RTEvent_Skel
...
RTEC_Federated_Consumer: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming Svc_Utils RTEvent RTEvent_Skel
...
RTEC_Federated_Supplier: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming Svc_Utils RTEvent RTEvent_Skel RTEvent_Serv
...
RTEC_Filter_Consumer: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming Svc_Utils RTEvent RTEvent_Skel
...
RTEC_Filter_Supplier: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming Svc_Utils RTEvent RTEvent_Skel
...
RTEC_MCast_Federated__Dev_Consumer: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming Svc_Utils RTEvent RTEvent_Skel
...
RTEC_MCast_Federated__Dev_Supplier: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming Svc_Utils RTEvent RTEvent_Skel RTEvent_Serv
...
ImplRepo_Basic_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode ImplRepo_Basic_Idl
...
ImplRepo_Basic_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer ImplRepo_Basic_Idl ImplRepo_Basic_Client
...
NamingService_Messenger_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode CosNaming NamingService_Messenger_Idl
...
CosNaming_Skel: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming
	$(KEEP_GOING)@cd orbsvcs/orbsvcs && $(MAKE) -f GNUmakefile.CosNaming_Skel all

.PHONY: NamingService_Messenger_Server
NamingService_Messenger_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming NamingService_Messenger_Idl NamingService_Messenger_Client CosNaming_Skel
...
Naming_Client_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode CosNaming Naming_Client_Idl
...
Naming_Client_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming CosNaming_Skel Naming_Client_Idl Naming_Client_Client
...
Naming_Context_Ext_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming CosNaming_Skel Naming_Context_Ext_Idl
...
Naming_Context_Ext_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode CosNaming Naming_Context_Ext_Idl Naming_Context_Ext_Server
...
CosNaming_Serv: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming Svc_Utils IORTable CosNaming_Skel
	$(KEEP_GOING)@cd orbsvcs/orbsvcs && $(MAKE) -f GNUmakefile.CosNaming_Serv all

.PHONY: Naming_Server_Messenger
Naming_Server_Messenger: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming Svc_Utils IORTable CosNaming_Skel CosNaming_Serv
...
Corbaloc_Messenger_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming CosNaming_Skel Corbaloc_Messenger_Idl
...
Corbaloc_Messenger_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode CosNaming Corbaloc_Messenger_Idl Corbaloc_Messenger_Server
...
Corbaname_Messenger_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming CosNaming_Skel Corbaname_Messenger_Idl
...
Corbaname_Messenger_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode CosNaming Corbaname_Messenger_Idl Corbaname_Messenger_Server
...
EventSequence_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming CosEvent CosEvent_Skel EventSequence_Idl CosNotification CosNotification_Skel
...
EventSequence_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode CosNaming CosEvent EventSequence_Idl CosNotification EventSequence_Server
...
EventSequence_Consumer: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming CosEvent CosEvent_Skel EventSequence_Idl CosNotification CosNotification_Skel EventSequence_Server
...
Filtering_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming CosEvent CosEvent_Skel CosNotification CosNotification_Skel Filtering_Idl
...
Filtering_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode CosNaming CosEvent CosNotification Filtering_Idl Filtering_Server
...
Filtering_Consumer: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming CosEvent CosEvent_Skel CosNotification CosNotification_Skel Filtering_Idl Filtering_Server
...
NotifyServiceMessenger_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode CosNaming CosEvent CosNotification NotifyServiceMessenger_Idl
...
NotifyServiceMessenger_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming CosEvent CosEvent_Skel CosNotification CosNotification_Skel NotifyServiceMessenger_Idl NotifyServiceMessenger_Client
...
NotifyServiceMessenger_Consumer: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming CosEvent CosEvent_Skel CosNotification CosNotification_Skel NotifyServiceMessenger_Idl NotifyServiceMessenger_Client NotifyServiceMessenger_Server
...
OfferSubscriptions_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode CosNaming CosEvent CosNotification OfferSubscriptions_Idl
...
OfferSubscriptions_Consumer: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming CosEvent CosEvent_Skel CosNotification CosNotification_Skel OfferSubscriptions_Idl OfferSubscriptions_Client
...
OfferSubscriptions_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming CosEvent CosEvent_Skel CosNotification CosNotification_Skel OfferSubscriptions_Idl OfferSubscriptions_Client OfferSubscriptions_Consumer
...
QoSProperties_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming CosEvent CosEvent_Skel CosNotification CosNotification_Skel QoSProperties_Idl
...
QoSProperties_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode CosNaming CosEvent CosNotification QoSProperties_Idl QoSProperties_Server
...
QoSProperties_Consumer: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming CosEvent CosEvent_Skel CosNotification CosNotification_Skel QoSProperties_Idl QoSProperties_Server
...
RTNotify_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer RTCORBA CosNaming CosEvent CosEvent_Skel CosNotification CosNotification_Skel RTNotify_Idl
...
RTNotify_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode CosNaming CosEvent CosNotification RTNotify_Idl RTNotify_Server
...
RTNotify_Consumer: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer RTCORBA RTPortableServer CosNaming CosEvent CosEvent_Skel CosNotification CosNotification_Skel RTNotify_Idl RTNotify_Server
...
SupplierSideNC_Consumer: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming CosEvent CosEvent_Skel CosNotification CosNotification_Skel SupplierSideNC_Idl
...
SupplierSideNC_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode CosNaming CosEvent CosNotification SupplierSideNC_Idl SupplierSideNC_Consumer
...
CosNotification_Serv: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosEvent CosEvent_Skel Svc_Utils CosNotification CosNotification_Skel TAO_ETCL DynamicAny
	$(KEEP_GOING)@cd orbsvcs/orbsvcs && $(MAKE) -f GNUmakefile.CosNotification_Serv all

.PHONY: SupplierSideNC_Server
SupplierSideNC_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming CosEvent CosEvent_Skel Svc_Utils CosNotification CosNotification_Skel SupplierSideNC_Idl SupplierSideNC_Consumer TAO_ETCL DynamicAny CosNotification_Serv
...
PICurrent_NameService_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI CosNaming PICurrent_NameService_Idl
...
PICurrent_NameService_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer PI_Server CosNaming PICurrent_NameService_Idl PICurrent_NameService_Client
...
.PHONY: Security
Security: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer
	$(KEEP_GOING)@cd orbsvcs/orbsvcs && $(MAKE) -f GNUmakefile.Security all

.PHONY: SSLIOP
SSLIOP: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer PI_Server Security
...
Notify_Consumer: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype PortableServer CosEvent CosEvent_Skel CosNotification
	$(KEEP_GOING)@cd orbsvcs/DevGuideExamples/ValueTypes/Notify && $(MAKE) -f GNUmakefile.Notify_Consumer all

.PHONY: Notify_Supplier
Notify_Supplier: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype PortableServer CosEvent CosEvent_Skel CosNotification Notify_Consumer
	$(KEEP_GOING)@cd orbsvcs/DevGuideExamples/ValueTypes/Notify && $(MAKE) -f GNUmakefile.Notify_Supplier all

.PHONY: Dump_Schedule
Dump_Schedule: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming Svc_Utils IORTable RTSched
	$(KEEP_GOING)@cd orbsvcs/Dump_Schedule && $(MAKE) -f GNUmakefile.Dump_Schedule all

.PHONY: RTSchedEvent
RTSchedEvent: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming Svc_Utils RTEvent RTEvent_Skel RTEvent_Serv RTSched
	$(KEEP_GOING)@cd orbsvcs/orbsvcs && $(MAKE) -f GNUmakefile.RTSchedEvent all

.PHONY: Event_Service
Event_Service: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging BiDir_GIOP CosNaming Svc_Utils RTEvent RTEvent_Skel RTEvent_Serv RTSched RTSchedEvent
...
.PHONY: PortableGroup
PortableGroup: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming IORManipulation
	$(KEEP_GOING)@cd orbsvcs/orbsvcs && $(MAKE) -f GNUmakefile.PortableGroup all

.PHONY: FTORB_Utils
FTORB_Utils: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming IORManipulation PortableGroup
	$(KEEP_GOING)@cd orbsvcs/orbsvcs && $(MAKE) -f GNUmakefile.FTORB_Utils all

.PHONY: FtRtEvent
FtRtEvent: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging PI_Server CosNaming Svc_Utils RTEvent RTEvent_Skel RTEvent_Serv IORManipulation PortableGroup FTORB_Utils
	$(KEEP_GOING)@cd orbsvcs/orbsvcs && $(MAKE) -f GNUmakefile.FtRtEvent all

.PHONY: FTRT_EventChannel
FTRT_EventChannel: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging PI_Server CosNaming Svc_Utils RTEvent RTEvent_Skel RTEvent_Serv TAO_Utils IORManipulation PortableGroup FTORB_Utils FtRtEvent
	$(KEEP_GOING)@cd orbsvcs/orbsvcs && $(MAKE) -f GNUmakefile.FTRT_EventChannel all

.PHONY: FTRT_Event_Service
FTRT_Event_Service: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging PI_Server CosNaming Svc_Utils RTEvent RTEvent_Skel RTEvent_Serv TAO_Utils RTSched RTSchedEvent IORManipulation PortableGroup FTORB_Utils FtRtEvent FTRT_EventChannel
	$(KEEP_GOING)@cd orbsvcs/FTRT_Event_Service/Event_Service && $(MAKE) -f GNUmakefile.FTRT_Event_Service all

.PHONY: FT_ServerORB
FT_ServerORB: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging PI_Server CosNaming IORManipulation PortableGroup FTORB_Utils
	$(KEEP_GOING)@cd orbsvcs/orbsvcs && $(MAKE) -f GNUmakefile.FT_ServerORB all

.PHONY: FT_ClientORB
FT_ClientORB: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming IORManipulation PortableGroup FTORB_Utils
	$(KEEP_GOING)@cd orbsvcs/orbsvcs && $(MAKE) -f GNUmakefile.FT_ClientORB all

.PHONY: FaultTolerance
FaultTolerance: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging PI_Server CosNaming CosEvent CosNotification IORManipulation PortableGroup FTORB_Utils FT_ServerORB FT_ClientORB
	$(KEEP_GOING)@cd orbsvcs/orbsvcs && $(MAKE) -f GNUmakefile.FaultTolerance all

.PHONY: FTRTEC_Factory_Service
FTRTEC_Factory_Service: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging PI_Server CosNaming CosEvent CosEvent_Skel Strategies CosNotification IORManipulation PortableGroup FTORB_Utils FT_ServerORB FT_ClientORB FaultTolerance
...
FTRT_ClientORB: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging
	$(KEEP_GOING)@cd orbsvcs/orbsvcs && $(MAKE) -f GNUmakefile.FTRT_ClientORB all

.PHONY: FTRTEC_Gateway_Service
FTRTEC_Gateway_Service: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging PI_Server CosNaming Svc_Utils RTEvent RTEvent_Skel RTEvent_Serv Strategies IORManipulation PortableGroup FTORB_Utils FtRtEvent FT_ClientORB FTRT_ClientORB
...
FT_ReplicationManager_Lib: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging PI_Server CosNaming CosEvent CosEvent_Skel CosNotification CosNotification_Skel IORManipulation PortableGroup FTORB_Utils FT_ServerORB FT_ClientORB FaultTolerance
	$(KEEP_GOING)@cd orbsvcs/FT_ReplicationManager && $(MAKE) -f GNUmakefile.FT_ReplicationManager_Lib all

.PHONY: FT_ReplicationManager
FT_ReplicationManager: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging PI_Server CosNaming CosEvent CosEvent_Skel IORTable CosNotification CosNotification_Skel IORManipulation PortableGroup FTORB_Utils FT_ServerORB FT_ClientORB FaultTolerance FT_ReplicationManager_Lib
	$(KEEP_GOING)@cd orbsvcs/FT_ReplicationManager && $(MAKE) -f GNUmakefile.FT_ReplicationManager all

.PHONY: Fault_Detector
Fault_Detector: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging PI_Server CosNaming CosEvent CosNotification IORManipulation PortableGroup FTORB_Utils FT_ServerORB FT_ClientORB FaultTolerance
	$(KEEP_GOING)@cd orbsvcs/Fault_Detector && $(MAKE) -f GNUmakefile.Fault_Detector all

.PHONY: Fault_Notifier
Fault_Notifier: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging PI_Server CosNaming CosEvent CosEvent_Skel Svc_Utils CosNotification CosNotification_Skel TAO_ETCL DynamicAny CosNotification_Serv IORManipulation PortableGroup FTORB_Utils FT_ServerORB FT_ClientORB FaultTolerance
...
.PHONY: ImR_Client
ImR_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer ImR_Client_Idl
...
.PHONY: IFR_Service
IFR_Service: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer PI_Server Svc_Utils IORTable IFR_Client TypeCodeFactory ImR_Client IFR_Client_skel IFRService
	$(KEEP_GOING)@cd orbsvcs/IFR_Service && $(MAKE) -f GNUmakefile.IFR_Service all

.PHONY: TAO_IFR_BE
TAO_IFR_BE: TAO_IDL_FE TAO_IDL_EXE TAO Codeset AnyTypeCode IFR_Client IFR_Service
	$(KEEP_GOING)@cd orbsvcs/IFR_Service && $(MAKE) -f GNUmakefile.TAO_IFR_BE all

.PHONY: TAO_IFR_EXE
TAO_IFR_EXE: TAO_IDL_FE TAO_IDL_EXE TAO Codeset AnyTypeCode IFR_Client TAO_IFR_BE
	$(KEEP_GOING)@cd orbsvcs/IFR_Service && $(MAKE) -f GNUmakefile.TAO_IFR_EXE all

.PHONY: ImR_Activator_IDL
ImR_Activator_IDL: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer ImR_Client
	$(KEEP_GOING)@cd orbsvcs/ImplRepo_Service && $(MAKE) -f GNUmakefile.ImR_Activator_IDL all

.PHONY: ImR_Locator_IDL
ImR_Locator_IDL: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging ImR_Client ImR_Activator_IDL
	$(KEEP_GOING)@cd orbsvcs/ImplRepo_Service && $(MAKE) -f GNUmakefile.ImR_Locator_IDL all

.PHONY: ImR_Activator
ImR_Activator: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging ImR_Client ImR_Activator_IDL ImR_Locator_IDL
	$(KEEP_GOING)@cd orbsvcs/ImplRepo_Service && $(MAKE) -f GNUmakefile.ImR_Activator all

.PHONY: ImR_Activator_Service
ImR_Activator_Service: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging Svc_Utils ImR_Client ImR_Activator_IDL ImR_Locator_IDL ImR_Activator
	$(KEEP_GOING)@cd orbsvcs/ImplRepo_Service && $(MAKE) -f GNUmakefile.ImR_Activator_Service all

.PHONY: ImR_Locator
ImR_Locator: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging Svc_Utils IORTable ImR_Client ImR_Activator_IDL ImR_Locator_IDL
	$(KEEP_GOING)@cd orbsvcs/ImplRepo_Service && $(MAKE) -f GNUmakefile.ImR_Locator all

.PHONY: ImR_Locator_Service
ImR_Locator_Service: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging PI_Server Svc_Utils IORTable ImR_Client ImR_Activator_IDL ImR_Locator_IDL ImR_Locator
	$(KEEP_GOING)@cd orbsvcs/ImplRepo_Service && $(MAKE) -f GNUmakefile.ImR_Locator_Service all

.PHONY: tao_imr
tao_imr: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer ImR_Client
...
LifeCycle_Service: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer CosNaming Svc_Utils IORTable TAO_Utils CosLifeCycle CosLifeCycle_Skel DynamicAny CosTrading CosTrading_Skel CosTrading_Serv
	$(KEEP_GOING)@cd orbsvcs/LifeCycle_Service && $(MAKE) -f GNUmakefile.LifeCycle_Service all

.PHONY: CosLoadBalancing
CosLoadBalancing: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging PI_Server ObjRefTemplate IORInterceptor CosNaming IORManipulation PortableGroup
	$(KEEP_GOING)@cd orbsvcs/orbsvcs && $(MAKE) -f GNUmakefile.CosLoadBalancing all

.PHONY: LoadManager
LoadManager: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging PI_Server ObjRefTemplate IORInterceptor CosNaming IORTable IORManipulation PortableGroup CosLoadBalancing
	$(KEEP_GOING)@cd orbsvcs/LoadBalancer && $(MAKE) -f GNUmakefile.LoadManager all

.PHONY: LoadMonitor
LoadMonitor: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging PI_Server ObjRefTemplate IORInterceptor CosNaming IORManipulation PortableGroup CosLoadBalancing LoadManager
...
Basic_Logging_Service: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer CosNaming Svc_Utils IORTable TAO_Utils TAO_ETCL DynamicAny DsLogAdmin DsLogAdmin_Skel DsLogAdmin_Serv
...
DsEventLogAdmin_Serv: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming CosEvent CosEvent_Skel Svc_Utils TAO_Utils IFR_Client DynamicInterface CosEvent_Serv TAO_ETCL DynamicAny DsLogAdmin DsLogAdmin_Skel DsLogAdmin_Serv DsEventLogAdmin DsEventLogAdmin_Skel
	$(KEEP_GOING)@cd orbsvcs/orbsvcs && $(MAKE) -f GNUmakefile.DsEventLogAdmin_Serv all

.PHONY: Event_Logging_Service
Event_Logging_Service: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming CosEvent CosEvent_Skel Svc_Utils IORTable TAO_Utils IFR_Client DynamicInterface CosEvent_Serv TAO_ETCL DynamicAny DsLogAdmin DsLogAdmin_Skel DsLogAdmin_Serv DsEventLogAdmin DsEventLogAdmin_Skel DsEventLogAdmin_Serv
...
DsNotifyLogAdmin_Serv: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer CosEvent CosEvent_Skel Svc_Utils TAO_Utils CosNotification CosNotification_Skel TAO_ETCL DynamicAny DsLogAdmin DsLogAdmin_Skel DsLogAdmin_Serv DsEventLogAdmin DsEventLogAdmin_Skel DsNotifyLogAdmin DsNotifyLogAdmin_Skel
	$(KEEP_GOING)@cd orbsvcs/orbsvcs && $(MAKE) -f GNUmakefile.DsNotifyLogAdmin_Serv all

.PHONY: Notify_Logging_Service
Notify_Logging_Service: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming CosEvent CosEvent_Skel Svc_Utils IORTable TAO_Utils CosNotification CosNotification_Skel TAO_ETCL DynamicAny CosNotification_Serv DsLogAdmin DsLogAdmin_Skel DsLogAdmin_Serv DsEventLogAdmin DsEventLogAdmin_Skel DsNotifyLogAdmin DsNotifyLogAdmin_Skel DsNotifyLogAdmin_Serv
...
RTEventLogAdmin_Serv: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming Svc_Utils RTEvent RTEvent_Skel RTEvent_Serv TAO_Utils RTSched TAO_ETCL DynamicAny DsLogAdmin DsLogAdmin_Skel DsLogAdmin_Serv RTEventLogAdmin RTEventLogAdmin_Skel
	$(KEEP_GOING)@cd orbsvcs/orbsvcs && $(MAKE) -f GNUmakefile.RTEventLogAdmin_Serv all

.PHONY: RTEvent_Logging_Service
RTEvent_Logging_Service: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming Svc_Utils RTEvent RTEvent_Skel RTEvent_Serv IORTable TAO_Utils RTSched TAO_ETCL DynamicAny DsLogAdmin DsLogAdmin_Skel DsLogAdmin_Serv RTEventLogAdmin RTEventLogAdmin_Skel RTEventLogAdmin_Serv
...
Naming_Service: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming Svc_Utils IORTable CosNaming_Skel CosNaming_Serv ImR_Client
	$(KEEP_GOING)@cd orbsvcs/Naming_Service && $(MAKE) -f GNUmakefile.Naming_Service all

.PHONY: NT_Naming_Service
NT_Naming_Service: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming Svc_Utils IORTable CosNaming_Skel CosNaming_Serv Naming_Service
	$(KEEP_GOING)@cd orbsvcs/Naming_Service && $(MAKE) -f GNUmakefile.NT_Naming_Service all

.PHONY: TAO_Notify_Service
TAO_Notify_Service: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming CosEvent CosEvent_Skel Svc_Utils IORTable CosNotification CosNotification_Skel TAO_ETCL DynamicAny CosNotification_Serv
	$(KEEP_GOING)@cd orbsvcs/Notify_Service && $(MAKE) -f GNUmakefile.TAO_Notify_Service all

.PHONY: NT_Notify_Service
NT_Notify_Service: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming CosEvent CosEvent_Skel Svc_Utils IORTable CosNotification CosNotification_Skel TAO_ETCL DynamicAny CosNotification_Serv TAO_Notify_Service
	$(KEEP_GOING)@cd orbsvcs/Notify_Service && $(MAKE) -f GNUmakefile.NT_Notify_Service all

.PHONY: Notify_Service
Notify_Service: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming CosEvent CosEvent_Skel Svc_Utils IORTable CosNotification CosNotification_Skel TAO_ETCL DynamicAny CosNotification_Serv TAO_Notify_Service
	$(KEEP_GOING)@cd orbsvcs/Notify_Service && $(MAKE) -f GNUmakefile.Notify_Service all

.PHONY: Scheduling_Service
Scheduling_Service: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer CosNaming Svc_Utils IORTable TAO_Utils RTSched
	$(KEEP_GOING)@cd orbsvcs/Scheduling_Service && $(MAKE) -f GNUmakefile.Scheduling_Service all

.PHONY: TAO_Service
TAO_Service: TAO_IDL_EXE TAO Codeset
...
Time_Service_Clerk: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer CosNaming Svc_Utils TAO_Utils CosTime CosTime_Skel CosTime_Serv
	$(KEEP_GOING)@cd orbsvcs/Time_Service && $(MAKE) -f GNUmakefile.Time_Service_Clerk all

.PHONY: Time_Service_Server
Time_Service_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer CosNaming Svc_Utils TAO_Utils CosTime CosTime_Skel CosTime_Serv
	$(KEEP_GOING)@cd orbsvcs/Time_Service && $(MAKE) -f GNUmakefile.Time_Service_Server all

.PHONY: Trading_Service
Trading_Service: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer CosNaming Svc_Utils IORTable TAO_Utils DynamicAny CosTrading CosTrading_Skel CosTrading_Serv
...
CosEC_Factory_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming CosEvent CosEvent_Skel CosEC_Factory_Idl
	$(KEEP_GOING)@cd orbsvcs/examples/CosEC/Factory && $(MAKE) -f GNUmakefile.CosEC_Factory_Client all

.PHONY: CosEC_Factory_Server
CosEC_Factory_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming CosEvent CosEvent_Skel Svc_Utils IFR_Client DynamicInterface CosEvent_Serv CosEC_Factory_Idl CosEC_Factory_Client
	$(KEEP_GOING)@cd orbsvcs/examples/CosEC/Factory && $(MAKE) -f GNUmakefile.CosEC_Factory_Server all

.PHONY: CosEC_RtEC_Based_lib
CosEC_RtEC_Based_lib: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosEvent CosEvent_Skel Svc_Utils RTEvent RTEvent_Skel RTEvent_Serv
...
CosEC_RtEC_Based_bin: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming CosEvent CosEvent_Skel Svc_Utils RTEvent RTEvent_Skel RTEvent_Serv CosEC_RtEC_Based_lib
...
CosEC_RtEC_Based_Tests_Basic_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming CosEvent CosEvent_Skel Svc_Utils RTEvent RTEvent_Skel RTEvent_Serv RTSched CosEC_RtEC_Based_lib
...
CosEC_RtEC_Based_Mult_Cons: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming CosEvent CosEvent_Skel Svc_Utils RTEvent RTEvent_Skel RTEvent_Serv RTSched CosEC_RtEC_Based_lib
...
CosEC_RtEC_Based_Mult_Supp: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming CosEvent CosEvent_Skel Svc_Utils RTEvent RTEvent_Skel RTEvent_Serv RTSched CosEC_RtEC_Based_lib CosEC_RtEC_Based_Mult_Cons
...
CosEC_Simple_Service: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming CosEvent CosEvent_Skel Svc_Utils IFR_Client DynamicInterface CosEvent_Serv
...
CosEC_TypedSimple_Consumer: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming CosEvent CosEvent_Skel
...
CosEC_TypedSimple_Supplier: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming CosEvent CosEvent_Skel CosEC_TypedSimple_Consumer
...
RolyPoly_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging PI_Server CosNaming CosEvent CosNotification IORManipulation PortableGroup FTORB_Utils FT_ServerORB FT_ClientORB FaultTolerance RolyPoly_Idl
	$(KEEP_GOING)@cd orbsvcs/examples/FaultTolerance/RolyPoly && $(MAKE) -f GNUmakefile.RolyPoly_Client all

.PHONY: RolyPoly_Server
RolyPoly_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging PI_Server CosNaming CosEvent CosNotification IORManipulation PortableGroup FTORB_Utils FT_ServerORB FT_ClientORB FaultTolerance RolyPoly_Idl RolyPoly_Client
...
Advanced_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer IORTable Advanced_IDL Advanced_Client
	$(KEEP_GOING)@cd orbsvcs/examples/ImR/Advanced && $(MAKE) -f GNUmakefile.Advanced_Server all

.PHONY: Advanced_Manager
Advanced_Manager: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer Advanced_IDL Advanced_Server
...
LoadBalancing_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging PI_Server ObjRefTemplate IORInterceptor CosNaming IORManipulation PortableGroup CosLoadBalancing LoadBalancing_Idl
	$(KEEP_GOING)@cd orbsvcs/examples/LoadBalancing && $(MAKE) -f GNUmakefile.LoadBalancing_Server all

.PHONY: LoadBalancing_Client
LoadBalancing_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI Strategies LoadBalancing_Idl LoadBalancing_Server
	$(KEEP_GOING)@cd orbsvcs/examples/LoadBalancing && $(MAKE) -f GNUmakefile.LoadBalancing_Client all

.PHONY: Log_Basic_Client
Log_Basic_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode CosNaming DsLogAdmin
	$(KEEP_GOING)@cd orbsvcs/examples/Log/Basic && $(MAKE) -f GNUmakefile.Log_Basic_Client all

.PHONY: Log_Event_Consumer
Log_Event_Consumer: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming CosEvent CosEvent_Skel DsLogAdmin DsEventLogAdmin
	$(KEEP_GOING)@cd orbsvcs/examples/Log/Event && $(MAKE) -f GNUmakefile.Log_Event_Consumer all

.PHONY: Log_Event_Supplier
Log_Event_Supplier: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming CosEvent CosEvent_Skel DsLogAdmin DsEventLogAdmin
	$(KEEP_GOING)@cd orbsvcs/examples/Log/Event && $(MAKE) -f GNUmakefile.Log_Event_Supplier all

.PHONY: Log_Notify_Consumer
Log_Notify_Consumer: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming CosEvent CosEvent_Skel CosNotification CosNotification_Skel DsLogAdmin DsEventLogAdmin DsNotifyLogAdmin
	$(KEEP_GOING)@cd orbsvcs/examples/Log/Notify && $(MAKE) -f GNUmakefile.Log_Notify_Consumer all

.PHONY: Log_Notify_Supplier
Log_Notify_Supplier: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming CosEvent CosEvent_Skel CosNotification CosNotification_Skel DsLogAdmin DsEventLogAdmin DsNotifyLogAdmin
	$(KEEP_GOING)@cd orbsvcs/examples/Log/Notify && $(MAKE) -f GNUmakefile.Log_Notify_Supplier all

.PHONY: Log_RTEvent_Consumer
Log_RTEvent_Consumer: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming Svc_Utils RTEvent RTEvent_Skel DsLogAdmin RTEventLogAdmin
	$(KEEP_GOING)@cd orbsvcs/examples/Log/RTEvent && $(MAKE) -f GNUmakefile.Log_RTEvent_Consumer all

.PHONY: Log_RTEvent_Supplier
Log_RTEvent_Supplier: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming Svc_Utils RTEvent RTEvent_Skel DsLogAdmin RTEventLogAdmin
...
.PHONY: Agent
Agent: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosEvent CosEvent_Skel Svc_Utils IFR_Client TypeCodeFactory CosNotification CosNotification_Skel TAO_ETCL DynamicAny CosNotification_Serv Gate
	$(KEEP_GOING)@cd orbsvcs/examples/Notify/Federation/Agent && $(MAKE) -f GNUmakefile.Agent all

.PHONY: SpaceCraft
SpaceCraft: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosEvent CosEvent_Skel Svc_Utils IFR_Client TypeCodeFactory CosNotification CosNotification_Skel TAO_ETCL DynamicAny CosNotification_Serv Gate
	$(KEEP_GOING)@cd orbsvcs/examples/Notify/Federation/SpaceCraft && $(MAKE) -f GNUmakefile.SpaceCraft all

.PHONY: Notify_Filter
Notify_Filter: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming CosEvent CosEvent_Skel CosNotification CosNotification_Skel
	$(KEEP_GOING)@cd orbsvcs/examples/Notify/Filter && $(MAKE) -f GNUmakefile.Notify_Filter all

.PHONY: RT_Notification
RT_Notification: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging RTCORBA CosEvent CosEvent_Skel Svc_Utils CosNotification CosNotification_Skel TAO_ETCL DynamicAny CosNotification_Serv
	$(KEEP_GOING)@cd orbsvcs/orbsvcs && $(MAKE) -f GNUmakefile.RT_Notification all

.PHONY: NotifyTests_Lib
NotifyTests_Lib: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming CosEvent CosEvent_Skel Svc_Utils IFR_Client DynamicInterface CosEvent_Serv CosNotification CosNotification_Skel TAO_ETCL DynamicAny CosNotification_Serv
	$(KEEP_GOING)@cd orbsvcs/tests/Notify/lib && $(MAKE) -f GNUmakefile.NotifyTests_Lib all

.PHONY: Notify_Lanes_Consumer
Notify_Lanes_Consumer: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging RTCORBA CosNaming CosEvent CosEvent_Skel Svc_Utils IFR_Client DynamicInterface CosEvent_Serv CosNotification CosNotification_Skel TAO_ETCL DynamicAny CosNotification_Serv RT_Notification NotifyTests_Lib
	$(KEEP_GOING)@cd orbsvcs/examples/Notify/Lanes && $(MAKE) -f GNUmakefile.Notify_Lanes_Consumer all

.PHONY: Notify_Lanes_Supplier
Notify_Lanes_Supplier: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging RTCORBA CosNaming CosEvent CosEvent_Skel Svc_Utils CosNotification CosNotification_Skel TAO_ETCL DynamicAny CosNotification_Serv RT_Notification Notify_Lanes_Consumer
...
CosNotification_MC: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming IORTable TAO_ETCL TAO_Monitor
	$(KEEP_GOING)@cd orbsvcs/orbsvcs && $(MAKE) -f GNUmakefile.CosNotification_MC all

.PHONY: mc_monitor_example
mc_monitor_example: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming IORTable TAO_ETCL TAO_Monitor CosNotification_MC
	$(KEEP_GOING)@cd orbsvcs/examples/Notify/MC/monitor && $(MAKE) -f GNUmakefile.mc_monitor_example all

.PHONY: Notify_Subscribe
Notify_Subscribe: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming CosEvent CosEvent_Skel CosNotification CosNotification_Skel
	$(KEEP_GOING)@cd orbsvcs/examples/Notify/Subscribe && $(MAKE) -f GNUmakefile.Notify_Subscribe all

.PHONY: Notify_ThreadPool_Supplier
Notify_ThreadPool_Supplier: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging RTCORBA RTPortableServer CosNaming CosEvent CosEvent_Skel Svc_Utils IFR_Client DynamicInterface CosEvent_Serv CosNotification CosNotification_Skel TAO_ETCL DynamicAny CosNotification_Serv RT_Notification NotifyTests_Lib
...
Notify_ThreadPool_Consumer: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging RTCORBA RTPortableServer CosNaming CosEvent CosEvent_Skel Svc_Utils IFR_Client DynamicInterface CosEvent_Serv CosNotification CosNotification_Skel TAO_ETCL DynamicAny CosNotification_Serv RT_Notification NotifyTests_Lib Notify_ThreadPool_Supplier
...
.PHONY: ORT_Gateway
ORT_Gateway: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging IFR_Client DynamicInterface ORT_Idl
	$(KEEP_GOING)@cd orbsvcs/examples/ORT && $(MAKE) -f GNUmakefile.ORT_Gateway all

.PHONY: ORT_Server
ORT_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging ObjRefTemplate IORInterceptor IFR_Client DynamicInterface ORT_Idl ORT_Gateway
	$(KEEP_GOING)@cd orbsvcs/examples/ORT && $(MAKE) -f GNUmakefile.ORT_Server all

.PHONY: ORT_Client
ORT_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode CosEvent ORT_Idl ORT_Server
	$(KEEP_GOING)@cd orbsvcs/examples/ORT && $(MAKE) -f GNUmakefile.ORT_Client all

.PHONY: RtEC_IIOPGateway
RtEC_IIOPGateway: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming Svc_Utils RTEvent RTEvent_Skel RTEvent_Serv
	$(KEEP_GOING)@cd orbsvcs/examples/RtEC/IIOPGateway && $(MAKE) -f GNUmakefile.RtEC_IIOPGateway all

.PHONY: RtEC_IIOPGateway_Consumer
RtEC_IIOPGateway_Consumer: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming Svc_Utils RTEvent RTEvent_Skel
...
RtEC_IIOPGateway_EC: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming Svc_Utils RTEvent RTEvent_Skel RTEvent_Serv
...
RtEC_IIOPGateway_Supplier: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming Svc_Utils RTEvent RTEvent_Skel
	$(KEEP_GOING)@cd orbsvcs/examples/RtEC/IIOPGateway && $(MAKE) -f GNUmakefile.RtEC_IIOPGateway_Supplier all

.PHONY: RTKokyuEvent
RTKokyuEvent: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming Svc_Utils RTEvent RTEvent_Skel RTEvent_Serv RTSched
	$(KEEP_GOING)@cd orbsvcs/orbsvcs && $(MAKE) -f GNUmakefile.RTKokyuEvent all

.PHONY: RtECKokyu
RtECKokyu: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming Svc_Utils RTEvent RTEvent_Skel RTEvent_Serv RTSched RTKokyuEvent
	$(KEEP_GOING)@cd orbsvcs/examples/RtEC/Kokyu && $(MAKE) -f GNUmakefile.RtECKokyu all

.PHONY: RtEC_MCast
RtEC_MCast: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming Svc_Utils RTEvent RTEvent_Skel RTEvent_Serv RTSched
	$(KEEP_GOING)@cd orbsvcs/examples/RtEC/MCast && $(MAKE) -f GNUmakefile.RtEC_MCast all

.PHONY: RtEC_Schedule
RtEC_Schedule: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming Svc_Utils RTEvent RTEvent_Skel RTEvent_Serv RTSched
	$(KEEP_GOING)@cd orbsvcs/examples/RtEC/Schedule && $(MAKE) -f GNUmakefile.RtEC_Schedule all

.PHONY: RtEC_Simple_Consumer
RtEC_Simple_Consumer: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming Svc_Utils RTEvent RTEvent_Skel
	$(KEEP_GOING)@cd orbsvcs/examples/RtEC/Simple && $(MAKE) -f GNUmakefile.RtEC_Simple_Consumer all

.PHONY: RtEC_Simple_Service
RtEC_Simple_Service: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming Svc_Utils RTEvent RTEvent_Skel RTEvent_Serv
	$(KEEP_GOING)@cd orbsvcs/examples/RtEC/Simple && $(MAKE) -f GNUmakefile.RtEC_Simple_Service all

.PHONY: RtEC_Simple_Supplier
RtEC_Simple_Supplier: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming Svc_Utils RTEvent RTEvent_Skel
...
Security_Send_File_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer Security_Send_File_Idl
...
Security_Send_File_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer Security_Send_File_Idl Security_Send_File_Server
...
CosProperty_Serv: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosProperty CosProperty_Skel
	$(KEEP_GOING)@cd orbsvcs/orbsvcs && $(MAKE) -f GNUmakefile.CosProperty_Serv all

#.PHONY: AV
#AV: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming CosProperty CosProperty_Skel CosProperty_Serv
#	$(KEEP_GOING)@cd orbsvcs/orbsvcs && $(MAKE) -f GNUmakefile.AV all

.PHONY: CosNotification_MC_Ext
CosNotification_MC_Ext: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming CosEvent CosEvent_Skel Svc_Utils IORTable CosNotification CosNotification_Skel TAO_ETCL DynamicAny CosNotification_Serv TAO_Monitor CosNotification_MC
	$(KEEP_GOING)@cd orbsvcs/orbsvcs && $(MAKE) -f GNUmakefile.CosNotification_MC_Ext all

.PHONY: CosNotification_Persist
CosNotification_Persist: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosEvent CosEvent_Skel Svc_Utils CosNotification CosNotification_Skel TAO_ETCL DynamicAny CosNotification_Serv
	$(KEEP_GOING)@cd orbsvcs/orbsvcs && $(MAKE) -f GNUmakefile.CosNotification_Persist all

.PHONY: HTIOP
HTIOP: TAO_IDL_EXE TAO Codeset AnyTypeCode
...
LoadBalancing_Performance_IDL: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging PI_Server ObjRefTemplate IORInterceptor CosNaming Strategies IORManipulation PortableGroup CosLoadBalancing
...
LoadBalancing_Performance_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging PI_Server ObjRefTemplate IORInterceptor CosNaming Strategies IORManipulation PortableGroup CosLoadBalancing LoadBalancing_Performance_IDL
...
LoadBalancing_Performance_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging PI_Server ObjRefTemplate IORInterceptor CosNaming Strategies IORManipulation PortableGroup CosLoadBalancing LoadBalancing_Performance_IDL LoadBalancing_Performance_Client
	$(KEEP_GOING)@cd orbsvcs/performance-tests/LoadBalancing/LBPerf/RPS && $(MAKE) -f GNUmakefile.LoadBalancing_Performance_Server all

.PHONY: RTEC_Perf
RTEC_Perf: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging RTCORBA RTPortableServer CosNaming Svc_Utils RTEvent RTEvent_Skel RTEvent_Serv Strategies RTCORBAEvent
	$(KEEP_GOING)@cd orbsvcs/performance-tests/RTEvent/lib && $(MAKE) -f GNUmakefile.RTEC_Perf all

.PHONY: Colocated_Roundtrip
Colocated_Roundtrip: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging RTCORBA RTPortableServer CosNaming Svc_Utils RTEvent RTEvent_Skel RTEvent_Serv Strategies RTCORBAEvent RTEC_Perf
...
Federated_Roundtrip_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging RTCORBA RTPortableServer CosNaming Svc_Utils RTEvent RTEvent_Skel RTEvent_Serv Strategies RTCORBAEvent RTEC_Perf
...
Federated_Roundtrip_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging RTCORBA RTPortableServer CosNaming Svc_Utils RTEvent RTEvent_Skel RTEvent_Serv Strategies RTCORBAEvent RTEC_Perf
...
RTCORBA_Baseline_IDL: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging RTCORBA RTPortableServer CosNaming Svc_Utils RTEvent RTEvent_Skel RTEvent_Serv Strategies RTCORBAEvent
...
RTCORBA_Baseline_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging RTCORBA RTPortableServer CosNaming Svc_Utils RTEvent RTEvent_Skel RTEvent_Serv Strategies RTCORBAEvent RTEC_Perf RTCORBA_Baseline_IDL
...
RTCORBA_Baseline_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging RTCORBA RTPortableServer CosNaming Svc_Utils RTEvent RTEvent_Skel RTEvent_Serv Strategies RTCORBAEvent RTEC_Perf RTCORBA_Baseline_IDL RTCORBA_Baseline_Server
...
RTCORBA_Callback_IDL: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging RTCORBA RTPortableServer CosNaming Svc_Utils RTEvent RTEvent_Skel RTEvent_Serv Strategies RTCORBAEvent
...
RTCORBA_Callback_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging RTCORBA RTPortableServer CosNaming Svc_Utils RTEvent RTEvent_Skel RTEvent_Serv Strategies RTCORBAEvent RTEC_Perf RTCORBA_Callback_IDL
...
RTCORBA_Callback_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging RTCORBA RTPortableServer CosNaming Svc_Utils RTEvent RTEvent_Skel RTEvent_Serv Strategies RTCORBAEvent RTEC_Perf RTCORBA_Callback_IDL RTCORBA_Callback_Client
...
Roundtrip_RTEvent_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging RTCORBA RTPortableServer CosNaming Svc_Utils RTEvent RTEvent_Skel RTEvent_Serv Strategies RTCORBAEvent RTEC_Perf
...
Roundtrip_RTEvent_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging RTCORBA RTPortableServer CosNaming Svc_Utils RTEvent RTEvent_Skel RTEvent_Serv Strategies RTCORBAEvent RTEC_Perf
...
TCP_Baseline_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging RTCORBA RTPortableServer CosNaming Svc_Utils RTEvent RTEvent_Skel RTEvent_Serv Strategies RTCORBAEvent RTEC_Perf
...
TCP_Baseline_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging RTCORBA RTPortableServer CosNaming Svc_Utils RTEvent RTEvent_Skel RTEvent_Serv Strategies RTCORBAEvent RTEC_Perf
...
AVS_Asynch_Three_Stage_Send: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming CosProperty CosProperty_Skel CosProperty_Serv AV
...
AVS_Asynch_Three_Stage_Dist: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming CosProperty CosProperty_Skel CosProperty_Serv AV AVS_Asynch_Three_Stage_Send
...
AVS_Asynch_Three_Stage_Recv: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming CosProperty CosProperty_Skel CosProperty_Serv AV AVS_Asynch_Three_Stage_Send
...
AVS_Bidirectional_Flows_Recv: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming CosProperty CosProperty_Skel CosProperty_Serv AV
...
AVS_Bidirectional_Flows_Send: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming CosProperty CosProperty_Skel CosProperty_Serv AV
...
AVS_Component_Switching_Recv: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer CosNaming Strategies CosProperty CosProperty_Skel CosProperty_Serv AV
...
AVS_Component_Switching_Dist: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer CosNaming Strategies CosProperty CosProperty_Skel CosProperty_Serv AV AVS_Component_Switching_Recv
...
AVS_Component_Switching_Send: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer CosNaming Strategies CosProperty CosProperty_Skel CosProperty_Serv AV AVS_Component_Switching_Recv
...
AVS_Full_Profile_Ftp: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming CosProperty CosProperty_Skel CosProperty_Serv AV
...
AVS_Full_Profile_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming CosProperty CosProperty_Skel CosProperty_Serv AV
	$(KEEP_GOING)@cd orbsvcs/tests/AVStreams/Full_Profile && $(MAKE) -f GNUmakefile.AVS_Full_Profile_Server all

.PHONY: AVS_Latency_Cntl
AVS_Latency_Cntl: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer CosNaming Strategies CosProperty CosProperty_Skel CosProperty_Serv AV
	$(KEEP_GOING)@cd orbsvcs/tests/AVStreams/Latency && $(MAKE) -f GNUmakefile.AVS_Latency_Cntl all

.PHONY: AVS_Latency_Ping
AVS_Latency_Ping: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer CosNaming Strategies CosProperty CosProperty_Skel CosProperty_Serv AV
	$(KEEP_GOING)@cd orbsvcs/tests/AVStreams/Latency && $(MAKE) -f GNUmakefile.AVS_Latency_Ping all

.PHONY: AVS_Latency_Pong
AVS_Latency_Pong: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer CosNaming Strategies CosProperty CosProperty_Skel CosProperty_Serv AV
	$(KEEP_GOING)@cd orbsvcs/tests/AVStreams/Latency && $(MAKE) -f GNUmakefile.AVS_Latency_Pong all

.PHONY: AVS_Modify_QoS_Recv
AVS_Modify_QoS_Recv: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming CosProperty CosProperty_Skel CosProperty_Serv AV
	$(KEEP_GOING)@cd orbsvcs/tests/AVStreams/Modify_QoS && $(MAKE) -f GNUmakefile.AVS_Modify_QoS_Recv all

.PHONY: AVS_Modify_QoS_Send
AVS_Modify_QoS_Send: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming CosProperty CosProperty_Skel CosProperty_Serv AV
	$(KEEP_GOING)@cd orbsvcs/tests/AVStreams/Modify_QoS && $(MAKE) -f GNUmakefile.AVS_Modify_QoS_Send all

.PHONY: AVS_Multicast_Ftp
AVS_Multicast_Ftp: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer CosNaming Strategies CosProperty CosProperty_Skel CosProperty_Serv AV
	$(KEEP_GOING)@cd orbsvcs/tests/AVStreams/Multicast && $(MAKE) -f GNUmakefile.AVS_Multicast_Ftp all

.PHONY: AVS_Multicast_Server
AVS_Multicast_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer CosNaming Strategies CosProperty CosProperty_Skel CosProperty_Serv AV
...
AVS_Multicast_Full_Profile_Ftp: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming CosProperty CosProperty_Skel CosProperty_Serv AV
...
AVS_Multicast_Full_Profile_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming CosProperty CosProperty_Skel CosProperty_Serv AV
...
AVS_Multiple_Flows_Recv: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming CosProperty CosProperty_Skel CosProperty_Serv AV
...
AVS_Multiple_Flows_Send: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming CosProperty CosProperty_Skel CosProperty_Serv AV
...
AVS_Pluggable_Ftp: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming CosProperty CosProperty_Skel CosProperty_Serv AV
	$(KEEP_GOING)@cd orbsvcs/tests/AVStreams/Pluggable && $(MAKE) -f GNUmakefile.AVS_Pluggable_Ftp all

.PHONY: AVS_Pluggable_Server
AVS_Pluggable_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming CosProperty CosProperty_Skel CosProperty_Serv AV
...
AVS_Pluggable_Flow_Protocol_Recv: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming CosProperty CosProperty_Skel CosProperty_Serv AV
...
AVS_Pluggable_Flow_Protocol_Send: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming CosProperty CosProperty_Skel CosProperty_Serv AV
...
AVS_Pluggable_Flow_Protocol_Ts: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming CosProperty CosProperty_Skel CosProperty_Serv AV
...
AVS_Simple_Three_Stage_Dist: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming CosProperty CosProperty_Skel CosProperty_Serv AV
...
AVS_Simple_Three_Stage_Recv: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming CosProperty CosProperty_Skel CosProperty_Serv AV
...
AVS_Simple_Three_Stage_Send: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming CosProperty CosProperty_Skel CosProperty_Serv AV
...
AVS_Simple_Two_Stage_Recv: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming CosProperty CosProperty_Skel CosProperty_Serv AV
...
AVS_Simple_Two_Stage_Send: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming CosProperty CosProperty_Skel CosProperty_Serv AV
...
AVS_Simple_Two_Stage_With_QoS_Recv: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming CosProperty CosProperty_Skel CosProperty_Serv AV
...
AVS_Simple_Two_Stage_With_QoS_Send: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming CosProperty CosProperty_Skel CosProperty_Serv AV
...
BiDirCORBALOC_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer BiDir_GIOP CosNaming TAO_Utils
	$(KEEP_GOING)@cd orbsvcs/tests/BiDir_CORBALOC && $(MAKE) -f GNUmakefile.BiDirCORBALOC_Server all

.PHONY: Bug_1334_client
Bug_1334_client: TAO_IDL_EXE TAO Codeset AnyTypeCode CosNaming
...
Bug_1395_Regression_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer Svc_Utils ImR_Client Bug_1395_Regression_IDL Bug_1395_Regression_Client
...
Bug_2074_Regression_Test: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming
...
Bug_2112_Regression_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming
...
Bug_2137_Regression_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming IORManipulation PortableGroup FTORB_Utils FT_ClientORB
...
Bug_2247_Regression_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging IORManipulation Bug_2247_Regression_Idl
...
Bug_2247_Regression_Manager: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging PI_Server CosNaming IORManipulation PortableGroup FTORB_Utils FT_ServerORB FT_ClientORB Bug_2247_Regression_Idl Bug_2247_Regression_Server
...
Bug_2248_Regression_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging PI_Server CosNaming IORManipulation PortableGroup FTORB_Utils FT_ServerORB FT_ClientORB Bug_2248_Regression_Idl
...
Bug_2248_Regression_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging PI_Server CosNaming IORManipulation PortableGroup FTORB_Utils FT_ServerORB FT_ClientORB Bug_2248_Regression_Idl Bug_2248_Regression_Server
...
Bug_2285_Regression_Server2: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging PI_Server CosNaming IORManipulation PortableGroup FTORB_Utils FT_ClientORB Bug_2285_Regression_IDL
...
Bug_2285_Regression_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming IORManipulation PortableGroup FTORB_Utils FT_ClientORB Bug_2285_Regression_IDL Bug_2285_Regression_Server2
...
Bug_2285_Regression_Client2: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming IORManipulation PortableGroup FTORB_Utils FT_ClientORB Bug_2285_Regression_IDL Bug_2285_Regression_Server2
...
Bug_2285_Regression_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging PI_Server CosNaming IORManipulation PortableGroup FTORB_Utils FT_ClientORB Bug_2285_Regression_IDL Bug_2285_Regression_Server2
...
Bug_2287_Regression_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming IORManipulation PortableGroup FTORB_Utils FT_ClientORB Bug_2287_Regression_IDL
...
Bug_2287_Regression_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging PI_Server CosNaming IORManipulation PortableGroup FTORB_Utils FT_ClientORB Bug_2287_Regression_IDL Bug_2287_Regression_Client
...
Bug_2316_Regression_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming IORManipulation PortableGroup Bug_2316_Regression_IDL
...
Bug_2316_Regression_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming IORManipulation PortableGroup Bug_2316_Regression_IDL Bug_2316_Regression_Client
...
Bug_2377_Regression_Test: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming IORManipulation PortableGroup
...
Bug_2615_Regression_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging PI_Server CosNaming IORManipulation PortableGroup FTORB_Utils FT_ClientORB Bug_2615_Regression_IDL
...
Bug_2615_Regression_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming IORManipulation PortableGroup FTORB_Utils FT_ClientORB Bug_2615_Regression_IDL Bug_2615_Regression_Server
...
Bug_2709_Regression_Idl: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging PI_Server CosNaming CosEvent CosNotification IORManipulation PortableGroup FTORB_Utils FT_ServerORB FT_ClientORB FaultTolerance
...
Bug_2709_Regression_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging PI_Server CosNaming CosEvent IORTable CosNotification IORManipulation PortableGroup FTORB_Utils FT_ServerORB FT_ClientORB FaultTolerance Bug_2709_Regression_Idl
...
Bug_2709_Regression_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging PI_Server CosNaming CosEvent IORTable CosNotification IORManipulation PortableGroup FTORB_Utils FT_ServerORB FT_ClientORB FaultTolerance Bug_2709_Regression_Idl Bug_2709_Regression_Client
...
Bug_2800_Regression_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming Bug_2800_Regression_Idl
...
Bug_2800_Regression_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode CosNaming Bug_2800_Regression_Idl Bug_2800_Regression_Server
...
Bug_2800_Regression_NsMain: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming Svc_Utils IORTable CosNaming_Skel CosNaming_Serv Bug_2800_Regression_Idl Bug_2800_Regression_Server
...
Bug_2925_Regression_IDL: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming IORManipulation PortableGroup DiffServPolicy
...
Bug_2925_Regression_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming IORManipulation PortableGroup DiffServPolicy Bug_2925_Regression_IDL
...
Bug_2925_Regression_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming IORManipulation PortableGroup DiffServPolicy Bug_2925_Regression_IDL Bug_2925_Regression_Server
...
Bug_3215_Regression_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming IORManipulation PortableGroup FTORB_Utils FT_ClientORB Bug_3215_Regression_IDL
...
Bug_3215_Regression_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging PI_Server CosNaming IORManipulation PortableGroup FTORB_Utils FT_ClientORB Bug_3215_Regression_IDL Bug_3215_Regression_Client
...
Bug_3216_Regression_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging PI_Server CosNaming IORManipulation PortableGroup FTORB_Utils FT_ClientORB Bug_3216_Regression_IDL
...
Bug_3216_Regression_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming IORManipulation PortableGroup FTORB_Utils FT_ClientORB Bug_3216_Regression_IDL Bug_3216_Regression_Server
...
Bug_3387_Regression_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming CosEvent CosEvent_Skel CosNotification CosNotification_Skel
...
Bug_3387_Regression_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode CosNaming CosEvent CosNotification Bug_3387_Regression_Server
...
Bug_3387_Regression_Consumer: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming CosEvent CosEvent_Skel CosNotification CosNotification_Skel Bug_3387_Regression_Server
...
Bug_3444_Regression_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming IORManipulation PortableGroup Bug_3444_Regression_IDL
...
Bug_3444_Regression_Client: TAO_IDL_EXE TAO Codeset Bug_3444_Regression_IDL Bug_3444_Regression_Server
...
Bug_3486_Regression_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming Svc_Utils IORTable CosNaming_Skel CosNaming_Serv Bug_3486_Regression_Lib
...
Bug_3598b_Regression_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming IORManipulation PortableGroup FTORB_Utils FT_ClientORB Bug_3598b_Regression_Idl
...
Bug_3673_Regression_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming Bug_3673_Regression_Idl
...
Bug_3673_Regression_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode CosNaming Bug_3673_Regression_Idl Bug_3673_Regression_Server
...
Bug_3673_Regression_NsMain: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming Svc_Utils IORTable CosNaming_Skel CosNaming_Serv Bug_3673_Regression_Idl Bug_3673_Regression_Server
...
Bug_3891_Regression: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer ImR_Client
...
COIOP_Naming_Test: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming Svc_Utils IORTable Strategies CosNaming_Skel CosNaming_Serv COIOP_Naming_Test_Idl
	$(KEEP_GOING)@cd orbsvcs/tests/COIOP_Naming_Test && $(MAKE) -f GNUmakefile.COIOP_Naming_Test all

.PHONY: CC_client
CC_client: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming Svc_Utils IORTable CosConcurrency
	$(KEEP_GOING)@cd orbsvcs/tests/Concurrency && $(MAKE) -f GNUmakefile.CC_client all

.PHONY: CosEvent_Test_Lib
CosEvent_Test_Lib: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosEvent CosEvent_Skel Svc_Utils IORTable
	$(KEEP_GOING)@cd orbsvcs/tests/CosEvent/lib && $(MAKE) -f GNUmakefile.CosEvent_Test_Lib all

.PHONY: CosEvent_Basic_Disconnect
CosEvent_Basic_Disconnect: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming CosEvent CosEvent_Skel Svc_Utils IORTable IFR_Client DynamicInterface CosEvent_Serv CosEvent_Test_Lib
...
CosEvent_Basic_MT_Disconnect: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming CosEvent CosEvent_Skel Svc_Utils IORTable IFR_Client DynamicInterface CosEvent_Serv CosEvent_Test_Lib
...
CosEvent_Basic_Pull_Push_Event: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming CosEvent CosEvent_Skel Svc_Utils IORTable IFR_Client DynamicInterface CosEvent_Serv CosEvent_Test_Lib
...
CosEvent_Basic_Push_Event: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming CosEvent CosEvent_Skel Svc_Utils IORTable IFR_Client DynamicInterface CosEvent_Serv CosEvent_Test_Lib
	$(KEEP_GOING)@cd orbsvcs/tests/CosEvent/Basic && $(MAKE) -f GNUmakefile.CosEvent_Basic_Push_Event all

.PHONY: CosEvent_Basic_Random
CosEvent_Basic_Random: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming CosEvent CosEvent_Skel Svc_Utils IORTable IFR_Client DynamicInterface CosEvent_Serv CosEvent_Test_Lib
	$(KEEP_GOING)@cd orbsvcs/tests/CosEvent/Basic && $(MAKE) -f GNUmakefile.CosEvent_Basic_Random all

.PHONY: CosEvent_Basic_Shutdown
CosEvent_Basic_Shutdown: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming CosEvent CosEvent_Skel Svc_Utils IORTable IFR_Client DynamicInterface CosEvent_Serv CosEvent_Test_Lib
	$(KEEP_GOING)@cd orbsvcs/tests/CosEvent/Basic && $(MAKE) -f GNUmakefile.CosEvent_Basic_Shutdown all

.PHONY: Timeout_Timeout
Timeout_Timeout: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming CosEvent CosEvent_Skel
	$(KEEP_GOING)@cd orbsvcs/tests/CosEvent/Timeout && $(MAKE) -f GNUmakefile.Timeout_Timeout all

.PHONY: EC_Custom_Marshal_IDL
EC_Custom_Marshal_IDL: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming Svc_Utils RTEvent RTEvent_Skel IORTable RTSched
	$(KEEP_GOING)@cd orbsvcs/tests/EC_Custom_Marshal && $(MAKE) -f GNUmakefile.EC_Custom_Marshal_IDL all

.PHONY: ECM_Consumer
ECM_Consumer: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming Svc_Utils RTEvent RTEvent_Skel IORTable RTSched EC_Custom_Marshal_IDL
	$(KEEP_GOING)@cd orbsvcs/tests/EC_Custom_Marshal && $(MAKE) -f GNUmakefile.ECM_Consumer all

.PHONY: ECM_Supplier
ECM_Supplier: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming Svc_Utils RTEvent RTEvent_Skel IORTable RTSched EC_Custom_Marshal_IDL ECM_Consumer
...
.PHONY: EC_Multiple
EC_Multiple: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming Svc_Utils RTEvent RTEvent_Skel RTEvent_Serv IORTable RTSched RTSchedEvent
	$(KEEP_GOING)@cd orbsvcs/tests/EC_Multiple && $(MAKE) -f GNUmakefile.EC_Multiple all

.PHONY: ECT_Throughput
ECT_Throughput: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming Svc_Utils RTEvent RTEvent_Skel RTEvent_Serv IORTable RTSched
	$(KEEP_GOING)@cd orbsvcs/tests/EC_Throughput && $(MAKE) -f GNUmakefile.ECT_Throughput all

.PHONY: ECT_Consumer
ECT_Consumer: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming Svc_Utils RTEvent RTEvent_Skel IORTable RTSched ECT_Throughput
	$(KEEP_GOING)@cd orbsvcs/tests/EC_Throughput && $(MAKE) -f GNUmakefile.ECT_Consumer all

.PHONY: ECT_Supplier
ECT_Supplier: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming Svc_Utils RTEvent RTEvent_Skel IORTable RTSched ECT_Throughput
	$(KEEP_GOING)@cd orbsvcs/tests/EC_Throughput && $(MAKE) -f GNUmakefile.ECT_Supplier all

.PHONY: Event_Test_Lib
Event_Test_Lib: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming Svc_Utils RTEvent RTEvent_Skel RTEvent_Serv
	$(KEEP_GOING)@cd orbsvcs/tests/Event/lib && $(MAKE) -f GNUmakefile.Event_Test_Lib all

.PHONY: Event_Basic_Atomic_Reconnect
Event_Basic_Atomic_Reconnect: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming Svc_Utils RTEvent RTEvent_Skel RTEvent_Serv IORTable Event_Test_Lib
	$(KEEP_GOING)@cd orbsvcs/tests/Event/Basic && $(MAKE) -f GNUmakefile.Event_Basic_Atomic_Reconnect all

.PHONY: Event_Basic_BCast
Event_Basic_BCast: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming Svc_Utils RTEvent RTEvent_Skel RTEvent_Serv IORTable Event_Test_Lib
	$(KEEP_GOING)@cd orbsvcs/tests/Event/Basic && $(MAKE) -f GNUmakefile.Event_Basic_BCast all

.PHONY: Event_Basic_Bitmask
Event_Basic_Bitmask: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming Svc_Utils RTEvent RTEvent_Skel RTEvent_Serv IORTable Event_Test_Lib
	$(KEEP_GOING)@cd orbsvcs/tests/Event/Basic && $(MAKE) -f GNUmakefile.Event_Basic_Bitmask all

.PHONY: Event_Basic_Complex
Event_Basic_Complex: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming Svc_Utils RTEvent RTEvent_Skel RTEvent_Serv IORTable Event_Test_Lib
	$(KEEP_GOING)@cd orbsvcs/tests/Event/Basic && $(MAKE) -f GNUmakefile.Event_Basic_Complex all

.PHONY: Event_Basic_Control
Event_Basic_Control: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming Svc_Utils RTEvent RTEvent_Skel RTEvent_Serv IORTable Event_Test_Lib
	$(KEEP_GOING)@cd orbsvcs/tests/Event/Basic && $(MAKE) -f GNUmakefile.Event_Basic_Control all

.PHONY: Event_Basic_Disconnect
Event_Basic_Disconnect: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming Svc_Utils RTEvent RTEvent_Skel RTEvent_Serv IORTable Event_Test_Lib
	$(KEEP_GOING)@cd orbsvcs/tests/Event/Basic && $(MAKE) -f GNUmakefile.Event_Basic_Disconnect all

.PHONY: Event_Basic_Gateway
Event_Basic_Gateway: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming Svc_Utils RTEvent RTEvent_Skel RTEvent_Serv IORTable Event_Test_Lib
	$(KEEP_GOING)@cd orbsvcs/tests/Event/Basic && $(MAKE) -f GNUmakefile.Event_Basic_Gateway all

.PHONY: Event_Basic_MT_Disconnect
Event_Basic_MT_Disconnect: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming Svc_Utils RTEvent RTEvent_Skel RTEvent_Serv IORTable Event_Test_Lib
	$(KEEP_GOING)@cd orbsvcs/tests/Event/Basic && $(MAKE) -f GNUmakefile.Event_Basic_MT_Disconnect all

.PHONY: Event_Basic_Negation
Event_Basic_Negation: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming Svc_Utils RTEvent RTEvent_Skel RTEvent_Serv IORTable Event_Test_Lib
	$(KEEP_GOING)@cd orbsvcs/tests/Event/Basic && $(MAKE) -f GNUmakefile.Event_Basic_Negation all

.PHONY: Event_Basic_Observer
Event_Basic_Observer: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming Svc_Utils RTEvent RTEvent_Skel RTEvent_Serv IORTable Event_Test_Lib
	$(KEEP_GOING)@cd orbsvcs/tests/Event/Basic && $(MAKE) -f GNUmakefile.Event_Basic_Observer all

.PHONY: Event_Basic_Random
Event_Basic_Random: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming Svc_Utils RTEvent RTEvent_Skel RTEvent_Serv IORTable Event_Test_Lib
	$(KEEP_GOING)@cd orbsvcs/tests/Event/Basic && $(MAKE) -f GNUmakefile.Event_Basic_Random all

.PHONY: Event_Basic_Reconnect
Event_Basic_Reconnect: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming Svc_Utils RTEvent RTEvent_Skel RTEvent_Serv IORTable Event_Test_Lib
	$(KEEP_GOING)@cd orbsvcs/tests/Event/Basic && $(MAKE) -f GNUmakefile.Event_Basic_Reconnect all

.PHONY: Event_Basic_Shutdown
Event_Basic_Shutdown: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming Svc_Utils RTEvent RTEvent_Skel RTEvent_Serv IORTable Event_Test_Lib
	$(KEEP_GOING)@cd orbsvcs/tests/Event/Basic && $(MAKE) -f GNUmakefile.Event_Basic_Shutdown all

.PHONY: Event_Basic_Timeout
Event_Basic_Timeout: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming Svc_Utils RTEvent RTEvent_Skel RTEvent_Serv IORTable Event_Test_Lib
	$(KEEP_GOING)@cd orbsvcs/tests/Event/Basic && $(MAKE) -f GNUmakefile.Event_Basic_Timeout all

.PHONY: Event_Basic_Wildcard
Event_Basic_Wildcard: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming Svc_Utils RTEvent RTEvent_Skel RTEvent_Serv IORTable Event_Test_Lib
...
Complex_Consumer: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming Svc_Utils RTEvent RTEvent_Skel RTEvent_Serv ECMcastTests_lib
	$(KEEP_GOING)@cd orbsvcs/tests/Event/Mcast/Complex && $(MAKE) -f GNUmakefile.Complex_Consumer all

.PHONY: Complex_Gateway_Ec
Complex_Gateway_Ec: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming Svc_Utils RTEvent RTEvent_Skel RTEvent_Serv ECMcastTests_lib
	$(KEEP_GOING)@cd orbsvcs/tests/Event/Mcast/Complex && $(MAKE) -f GNUmakefile.Complex_Gateway_Ec all

.PHONY: Complex_Supplier
Complex_Supplier: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming Svc_Utils RTEvent RTEvent_Skel RTEvent_Serv ECMcastTests_lib
...
RTEC_MCast_Federated_Consumer: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming Svc_Utils RTEvent RTEvent_Skel
...
RTEC_MCast_Federated_Supplier: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming Svc_Utils RTEvent RTEvent_Skel RTEvent_Serv
...
Simple_Consumer: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming Svc_Utils RTEvent RTEvent_Skel RTEvent_Serv ECMcastTests_lib
	$(KEEP_GOING)@cd orbsvcs/tests/Event/Mcast/Simple && $(MAKE) -f GNUmakefile.Simple_Consumer all

.PHONY: Simple_Gateway_Ec
Simple_Gateway_Ec: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming Svc_Utils RTEvent RTEvent_Skel RTEvent_Serv ECMcastTests_lib
	$(KEEP_GOING)@cd orbsvcs/tests/Event/Mcast/Simple && $(MAKE) -f GNUmakefile.Simple_Gateway_Ec all

.PHONY: Simple_Supplier
Simple_Supplier: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming Svc_Utils RTEvent RTEvent_Skel RTEvent_Serv ECMcastTests_lib
	$(KEEP_GOING)@cd orbsvcs/tests/Event/Mcast/Simple && $(MAKE) -f GNUmakefile.Simple_Supplier all

.PHONY: Two_Way_Application
Two_Way_Application: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming Svc_Utils RTEvent RTEvent_Skel RTEvent_Serv ECMcastTests_lib
	$(KEEP_GOING)@cd orbsvcs/tests/Event/Mcast/Two_Way && $(MAKE) -f GNUmakefile.Two_Way_Application all

.PHONY: Two_Way_Gateway_Ec
Two_Way_Gateway_Ec: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming Svc_Utils RTEvent RTEvent_Skel RTEvent_Serv ECMcastTests_lib
	$(KEEP_GOING)@cd orbsvcs/tests/Event/Mcast/Two_Way && $(MAKE) -f GNUmakefile.Two_Way_Gateway_Ec all

.PHONY: Event_Performance_Connect
Event_Performance_Connect: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming Svc_Utils RTEvent RTEvent_Skel RTEvent_Serv IORTable Event_Test_Lib
...
Event_Performance_Inversion: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming Svc_Utils RTEvent RTEvent_Skel RTEvent_Serv IORTable Event_Test_Lib
...
Event_Performance_Latency: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming Svc_Utils RTEvent RTEvent_Skel RTEvent_Serv IORTable Strategies Event_Test_Lib
...
Event_Performance_Latency_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming Svc_Utils RTEvent RTEvent_Skel RTEvent_Serv IORTable Strategies Event_Test_Lib
...
Event_Performance_Throughput: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming Svc_Utils RTEvent RTEvent_Skel RTEvent_Serv IORTable Event_Test_Lib
...
RtEC_UDP_Sender: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming Svc_Utils RTEvent RTEvent_Skel RTEvent_Serv RTSched RtEC_UDP_Idl
	$(KEEP_GOING)@cd orbsvcs/tests/Event/UDP && $(MAKE) -f GNUmakefile.RtEC_UDP_Sender all

.PHONY: RtEC_UDP_Receiver
RtEC_UDP_Receiver: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming Svc_Utils RTEvent RTEvent_Skel RTEvent_Serv RTSched RtEC_UDP_Sender
	$(KEEP_GOING)@cd orbsvcs/tests/Event/UDP && $(MAKE) -f GNUmakefile.RtEC_UDP_Receiver all

.PHONY: FT_App_Analyzer
FT_App_Analyzer: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging PI_Server CosNaming CosEvent CosEvent_Skel CosNotification CosNotification_Skel IORManipulation PortableGroup FTORB_Utils FT_ServerORB FT_ClientORB FaultTolerance
...
.PHONY: FT_App_Client
FT_App_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging PI_Server CosNaming CosEvent CosNotification IORManipulation PortableGroup FTORB_Utils FT_ServerORB FT_ClientORB FaultTolerance FT_App_Idl
	$(KEEP_GOING)@cd orbsvcs/tests/FT_App && $(MAKE) -f GNUmakefile.FT_App_Client all

.PHONY: FT_App_Creator
FT_App_Creator: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging PI_Server CosNaming CosEvent CosNotification IORManipulation PortableGroup FTORB_Utils FT_ServerORB FT_ClientORB FaultTolerance
	$(KEEP_GOING)@cd orbsvcs/tests/FT_App && $(MAKE) -f GNUmakefile.FT_App_Creator all

.PHONY: FT_App_FactoryRegistry
FT_App_FactoryRegistry: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging PI_Server CosNaming CosEvent CosNotification IORManipulation PortableGroup FTORB_Utils FT_ServerORB FT_ClientORB FaultTolerance
	$(KEEP_GOING)@cd orbsvcs/tests/FT_App && $(MAKE) -f GNUmakefile.FT_App_FactoryRegistry all

.PHONY: FT_App_FaultConsumer
FT_App_FaultConsumer: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging PI_Server CosNaming CosEvent CosEvent_Skel CosNotification CosNotification_Skel IORManipulation PortableGroup FTORB_Utils FT_ServerORB FT_ClientORB FaultTolerance FT_ReplicationManager_Lib
	$(KEEP_GOING)@cd orbsvcs/tests/FT_App && $(MAKE) -f GNUmakefile.FT_App_FaultConsumer all

.PHONY: FT_App_Notifier
FT_App_Notifier: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging PI_Server CosNaming CosEvent CosNotification IORManipulation PortableGroup FTORB_Utils FT_ServerORB FT_ClientORB FaultTolerance
	$(KEEP_GOING)@cd orbsvcs/tests/FT_App && $(MAKE) -f GNUmakefile.FT_App_Notifier all

.PHONY: FT_App_RMController
FT_App_RMController: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging PI_Server CosNaming CosEvent CosNotification IORManipulation PortableGroup FTORB_Utils FT_ServerORB FT_ClientORB FaultTolerance
	$(KEEP_GOING)@cd orbsvcs/tests/FT_App && $(MAKE) -f GNUmakefile.FT_App_RMController all

.PHONY: FT_App_Server
FT_App_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging PI_Server CosNaming CosEvent CosNotification IORManipulation PortableGroup FTORB_Utils FT_ServerORB FT_ClientORB FaultTolerance FT_App_Idl FT_App_Client
...
GroupRef_Manipulation_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging PI_Server CosNaming IORManipulation PortableGroup FTORB_Utils FT_ServerORB FT_ClientORB GroupRef_Manipulation_Idl
...
GroupRef_Manipulation_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging PI_Server CosNaming IORManipulation PortableGroup FTORB_Utils FT_ServerORB FT_ClientORB GroupRef_Manipulation_Idl GroupRef_Manipulation_Client
...
FaultTolerance_IOGR_Manager: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging PI_Server CosNaming IORManipulation PortableGroup FTORB_Utils FT_ServerORB FT_ClientORB FaultTolerance_IOGR_Idl
...
FaultTolerance_IOGR_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging PI_Server CosNaming IORManipulation PortableGroup FTORB_Utils FT_ServerORB FT_ClientORB FaultTolerance_IOGR_Idl FaultTolerance_IOGR_Manager
	$(KEEP_GOING)@cd orbsvcs/tests/FaultTolerance/IOGR && $(MAKE) -f GNUmakefile.FaultTolerance_IOGR_Server all

.PHONY: IOGRTest
IOGRTest: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging PI_Server CosNaming IORManipulation PortableGroup FTORB_Utils FT_ServerORB FT_ClientORB
	$(KEEP_GOING)@cd orbsvcs/tests/FaultTolerance/IOGRManipulation && $(MAKE) -f GNUmakefile.IOGRTest all

.PHONY: FtRtEvent_Consumer
FtRtEvent_Consumer: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging PI_Server CosNaming Svc_Utils RTEvent RTEvent_Skel RTEvent_Serv Strategies IORManipulation PortableGroup FTORB_Utils FtRtEvent FT_ClientORB FTRT_ClientORB
	$(KEEP_GOING)@cd orbsvcs/tests/FtRtEvent && $(MAKE) -f GNUmakefile.FtRtEvent_Consumer all

.PHONY: FtRtEvent_Supplier
FtRtEvent_Supplier: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging PI_Server CosNaming Svc_Utils RTEvent RTEvent_Skel RTEvent_Serv Strategies IORManipulation PortableGroup FTORB_Utils FtRtEvent FT_ClientORB FTRT_ClientORB
...
HTIOP_AMI_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging HTIOP_AMI_Idl
	$(KEEP_GOING)@cd orbsvcs/tests/HTIOP/AMI && $(MAKE) -f GNUmakefile.HTIOP_AMI_Client all

.PHONY: HTIOP_AMI_Server
HTIOP_AMI_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging HTIOP_AMI_Idl HTIOP_AMI_Client
	$(KEEP_GOING)@cd orbsvcs/tests/HTIOP/AMI && $(MAKE) -f GNUmakefile.HTIOP_AMI_Server all

.PHONY: HTIOP_AMI_Simple_Client
HTIOP_AMI_Simple_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging HTIOP_AMI_Idl HTIOP_AMI_Client
...
HTIOP_BiDirectional_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer BiDir_GIOP HTIOP_BiDirectional_Idl
...
HTIOP_BiDirectional_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer BiDir_GIOP HTIOP_BiDirectional_Idl HTIOP_BiDirectional_Server
...
HTIOP_Hello_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming IORTable HTIOP_Hello_Idl
	$(KEEP_GOING)@cd orbsvcs/tests/HTIOP/Hello && $(MAKE) -f GNUmakefile.HTIOP_Hello_Server all

.PHONY: HTIOP_Hello_Client
HTIOP_Hello_Client: TAO_IDL_EXE TAO Codeset HTIOP_Hello_Idl HTIOP_Hello_Server
...
IOR_MCast_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming Svc_Utils IORTable IOR_MCast_Idl
	$(KEEP_GOING)@cd orbsvcs/tests/IOR_MCast && $(MAKE) -f GNUmakefile.IOR_MCast_Server all

.PHONY: IOR_MCast_Client
IOR_MCast_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming Svc_Utils IORTable IOR_MCast_Idl IOR_MCast_Server
...
Bug_2604_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer ImR_Client Bug_2604_Idl
...
Bug_689_Regression_Client: TAO_IDL_EXE TAO Codeset Bug_689_Regression_Idl
...
Bug_689_Regression_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer ImR_Client Bug_689_Regression_Idl Bug_689_Regression_Client
...
airplane_server: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer IORTable ImR_Client airplane_idl airplane_client
...
.PHONY: nestea_server
nestea_server: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer IORTable ImR_Client nestea_idl
	$(KEEP_GOING)@cd orbsvcs/tests/ImplRepo && $(MAKE) -f GNUmakefile.nestea_server all

.PHONY: nestea_client
nestea_client: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer IORTable nestea_idl nestea_server
	$(KEEP_GOING)@cd orbsvcs/tests/ImplRepo && $(MAKE) -f GNUmakefile.nestea_client all

.PHONY: ImplRepo_NameService
ImplRepo_NameService: TAO_IDL_EXE TAO Codeset AnyTypeCode CosNaming
...
ReconnectServer_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer ReconnectServer_Idl
...
ReconnectServer_ServerB: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer ImR_Client ReconnectServer_Idl ReconnectServer_Client
...
ReconnectServer_ServerA: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer ImR_Client ReconnectServer_Idl ReconnectServer_Client ReconnectServer_ServerB
...
scaletest_client: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer IORTable scaletest_idl
	$(KEEP_GOING)@cd orbsvcs/tests/ImplRepo/scale && $(MAKE) -f GNUmakefile.scaletest_client all

.PHONY: scaletest_server
scaletest_server: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer IORTable ImR_Client scaletest_idl scaletest_client
...
Interoperable_Naming: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming
...
Application_Controlled_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging PI_Server ObjRefTemplate IORInterceptor CosNaming Svc_Utils IORManipulation PortableGroup CosLoadBalancing Application_Controlled_Idl
...
Application_Controlled_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging PI_Server ObjRefTemplate IORInterceptor CosNaming Svc_Utils IORManipulation PortableGroup CosLoadBalancing Application_Controlled_Idl Application_Controlled_Server
...
.PHONY: DeadMemberDetection_App_Ctrl_Idl
DeadMemberDetection_App_Ctrl_Idl: TAO_IDL_EXE
	$(KEEP_GOING)@cd orbsvcs/tests/LoadBalancing/GenericFactory/DeadMemberDetection_App_Ctrl && $(MAKE) -f GNUmakefile.DeadMemberDetection_App_Ctrl_Idl all

.PHONY: DeadMemberDetection_App_Ctrl_Client
DeadMemberDetection_App_Ctrl_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging PI_Server ObjRefTemplate IORInterceptor CosNaming Svc_Utils IORManipulation PortableGroup CosLoadBalancing DeadMemberDetection_App_Ctrl_Idl
	$(KEEP_GOING)@cd orbsvcs/tests/LoadBalancing/GenericFactory/DeadMemberDetection_App_Ctrl && $(MAKE) -f GNUmakefile.DeadMemberDetection_App_Ctrl_Client all

.PHONY: DeadMemberDetection_App_Ctrl_Server
DeadMemberDetection_App_Ctrl_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging PI_Server ObjRefTemplate IORInterceptor CosNaming Svc_Utils IORManipulation PortableGroup CosLoadBalancing DeadMemberDetection_App_Ctrl_Idl DeadMemberDetection_App_Ctrl_Client
	$(KEEP_GOING)@cd orbsvcs/tests/LoadBalancing/GenericFactory/DeadMemberDetection_App_Ctrl && $(MAKE) -f GNUmakefile.DeadMemberDetection_App_Ctrl_Server all

.PHONY: DeadMemberDetection_Inf_Ctrl_Idl
DeadMemberDetection_Inf_Ctrl_Idl: TAO_IDL_EXE
	$(KEEP_GOING)@cd orbsvcs/tests/LoadBalancing/GenericFactory/DeadMemberDetection_Inf_Ctrl && $(MAKE) -f GNUmakefile.DeadMemberDetection_Inf_Ctrl_Idl all

.PHONY: DeadMemberDetection_Inf_Ctrl_Factory
DeadMemberDetection_Inf_Ctrl_Factory: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging PI_Server ObjRefTemplate IORInterceptor CosNaming IORManipulation PortableGroup CosLoadBalancing DeadMemberDetection_Inf_Ctrl_Idl
	$(KEEP_GOING)@cd orbsvcs/tests/LoadBalancing/GenericFactory/DeadMemberDetection_Inf_Ctrl && $(MAKE) -f GNUmakefile.DeadMemberDetection_Inf_Ctrl_Factory all

.PHONY: DeadMemberDetection_Inf_Ctrl_Client
DeadMemberDetection_Inf_Ctrl_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging PI_Server ObjRefTemplate IORInterceptor CosNaming IORManipulation PortableGroup CosLoadBalancing DeadMemberDetection_Inf_Ctrl_Idl DeadMemberDetection_Inf_Ctrl_Factory
	$(KEEP_GOING)@cd orbsvcs/tests/LoadBalancing/GenericFactory/DeadMemberDetection_Inf_Ctrl && $(MAKE) -f GNUmakefile.DeadMemberDetection_Inf_Ctrl_Client all

.PHONY: DeadMemberDetection_Inf_Ctrl_Server
DeadMemberDetection_Inf_Ctrl_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging PI_Server ObjRefTemplate IORInterceptor CosNaming IORManipulation PortableGroup CosLoadBalancing DeadMemberDetection_Inf_Ctrl_Idl DeadMemberDetection_Inf_Ctrl_Factory
	$(KEEP_GOING)@cd orbsvcs/tests/LoadBalancing/GenericFactory/DeadMemberDetection_Inf_Ctrl && $(MAKE) -f GNUmakefile.DeadMemberDetection_Inf_Ctrl_Server all
...
Infrastructure_Controlled_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging PI_Server ObjRefTemplate IORInterceptor CosNaming IORManipulation PortableGroup CosLoadBalancing Infrastructure_Controlled_Idl
...
Infrastructure_Controlled_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging PI_Server ObjRefTemplate IORInterceptor CosNaming IORManipulation PortableGroup CosLoadBalancing Infrastructure_Controlled_Idl Infrastructure_Controlled_Client
...
Manage_Object_Group_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging PI_Server ObjRefTemplate IORInterceptor CosNaming Svc_Utils IORManipulation PortableGroup CosLoadBalancing
...
LoadMonitorCPU_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging PI_Server ObjRefTemplate IORInterceptor CosNaming IORManipulation PortableGroup CosLoadBalancing
...
Log_Basic_Log_Test: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CosNaming IORTable TAO_ETCL DynamicAny DsLogAdmin
...
McastHello_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming IORManipulation PortableGroup McastHello_Idl
	$(KEEP_GOING)@cd orbsvcs/tests/Miop/McastHello && $(MAKE) -f GNUmakefile.McastHello_Client all

.PHONY: McastHello_Server
McastHello_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming IORManipulation PortableGroup McastHello_Idl McastHello_Client
	$(KEEP_GOING)@cd orbsvcs/tests/Miop/McastHello && $(MAKE) -f GNUmakefile.McastHello_Server all

.PHONY: Basic_Notify_AdminProperties
Basic_Notify_AdminProperties: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming CosEvent CosEvent_Skel Svc_Utils IFR_Client DynamicInterface CosEvent_Serv CosNotification CosNotification_Skel TAO_ETCL DynamicAny CosNotification_Serv NotifyTests_Lib
...
Basic_Notify_ConnectDisconnect: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming CosEvent CosEvent_Skel Svc_Utils IFR_Client DynamicInterface CosEvent_Serv CosNotification CosNotification_Skel TAO_ETCL DynamicAny CosNotification_Serv NotifyTests_Lib
	$(KEEP_GOING)@cd orbsvcs/tests/Notify/Basic && $(MAKE) -f GNUmakefile.Basic_Notify_ConnectDisconnect all

.PHONY: Basic_Notify_Events
Basic_Notify_Events: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming CosEvent CosEvent_Skel Svc_Utils IFR_Client DynamicInterface CosEvent_Serv CosNotification CosNotification_Skel TAO_ETCL DynamicAny CosNotification_Serv NotifyTests_Lib
	$(KEEP_GOING)@cd orbsvcs/tests/Notify/Basic && $(MAKE) -f GNUmakefile.Basic_Notify_Events all

.PHONY: Basic_Notify_Filter
Basic_Notify_Filter: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming CosEvent CosEvent_Skel Svc_Utils IFR_Client DynamicInterface CosEvent_Serv CosNotification CosNotification_Skel TAO_ETCL DynamicAny CosNotification_Serv NotifyTests_Lib
	$(KEEP_GOING)@cd orbsvcs/tests/Notify/Basic && $(MAKE) -f GNUmakefile.Basic_Notify_Filter all

.PHONY: Basic_Notify_IdAssignment
Basic_Notify_IdAssignment: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming CosEvent CosEvent_Skel Svc_Utils IFR_Client DynamicInterface CosEvent_Serv CosNotification CosNotification_Skel TAO_ETCL DynamicAny CosNotification_Serv NotifyTests_Lib
	$(KEEP_GOING)@cd orbsvcs/tests/Notify/Basic && $(MAKE) -f GNUmakefile.Basic_Notify_IdAssignment all

.PHONY: Basic_Notify_LifeCycle
Basic_Notify_LifeCycle: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming CosEvent CosEvent_Skel Svc_Utils IFR_Client DynamicInterface CosEvent_Serv CosNotification CosNotification_Skel TAO_ETCL DynamicAny CosNotification_Serv NotifyTests_Lib
	$(KEEP_GOING)@cd orbsvcs/tests/Notify/Basic && $(MAKE) -f GNUmakefile.Basic_Notify_LifeCycle all

.PHONY: Basic_Notify_MultiTypes
Basic_Notify_MultiTypes: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming CosEvent CosEvent_Skel Svc_Utils IFR_Client DynamicInterface CosEvent_Serv CosNotification CosNotification_Skel TAO_ETCL DynamicAny CosNotification_Serv NotifyTests_Lib
	$(KEEP_GOING)@cd orbsvcs/tests/Notify/Basic && $(MAKE) -f GNUmakefile.Basic_Notify_MultiTypes all

.PHONY: Basic_Notify_Sequence
Basic_Notify_Sequence: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming CosEvent CosEvent_Skel Svc_Utils IFR_Client DynamicInterface CosEvent_Serv CosNotification CosNotification_Skel TAO_ETCL DynamicAny CosNotification_Serv NotifyTests_Lib
	$(KEEP_GOING)@cd orbsvcs/tests/Notify/Basic && $(MAKE) -f GNUmakefile.Basic_Notify_Sequence all

.PHONY: Basic_Notify_Simple
Basic_Notify_Simple: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming CosEvent CosEvent_Skel Svc_Utils IFR_Client DynamicInterface CosEvent_Serv CosNotification CosNotification_Skel TAO_ETCL DynamicAny CosNotification_Serv NotifyTests_Lib
	$(KEEP_GOING)@cd orbsvcs/tests/Notify/Basic && $(MAKE) -f GNUmakefile.Basic_Notify_Simple all

.PHONY: Basic_Notify_Updates
Basic_Notify_Updates: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming CosEvent CosEvent_Skel Svc_Utils IFR_Client DynamicInterface CosEvent_Serv CosNotification CosNotification_Skel TAO_ETCL DynamicAny CosNotification_Serv NotifyTests_Lib
...
Blocking_Ntf_Struct_Cons: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming CosEvent CosEvent_Skel Svc_Utils IFR_Client DynamicInterface CosEvent_Serv CosNotification CosNotification_Skel TAO_ETCL DynamicAny CosNotification_Serv NotifyTests_Lib Blocking_Idl
...
Blocking_Ntf_Struct_Supp: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming CosEvent CosEvent_Skel Svc_Utils IFR_Client DynamicInterface CosEvent_Serv CosNotification CosNotification_Skel TAO_ETCL DynamicAny CosNotification_Serv NotifyTests_Lib Blocking_Idl Blocking_Ntf_Struct_Cons
...
Bug_1385_Regression_Ntf_Struct_Supp: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming CosEvent CosEvent_Skel Svc_Utils IFR_Client DynamicInterface CosEvent_Serv CosNotification CosNotification_Skel TAO_ETCL DynamicAny CosNotification_Serv NotifyTests_Lib Bug_1385_Regression_Idl
...
Bug_1385_Regression_Ntf_Struct_Cons: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming CosEvent CosEvent_Skel Svc_Utils IFR_Client DynamicInterface CosEvent_Serv CosNotification CosNotification_Skel TAO_ETCL DynamicAny CosNotification_Serv NotifyTests_Lib Bug_1385_Regression_Idl Bug_1385_Regression_Ntf_Struct_Supp
...
Bug_1884_Regression_Consumer: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming CosEvent CosEvent_Skel CosNotification CosNotification_Skel
...
Bug_1884_Regression_Filter: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming CosEvent CosEvent_Skel CosNotification CosNotification_Skel
...
Bug_1884_Regression_Supplier: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming CosEvent CosEvent_Skel CosNotification CosNotification_Skel
...
Bug_2415_Regression_Consumer: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming CosEvent CosEvent_Skel Svc_Utils IFR_Client DynamicInterface CosEvent_Serv CosNotification CosNotification_Skel TAO_ETCL DynamicAny CosNotification_Serv NotifyTests_Lib Bug_2415_Regression_Idl
...
Bug_2415_Regression_Supplier: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming CosEvent CosEvent_Skel Svc_Utils IFR_Client DynamicInterface CosEvent_Serv CosNotification CosNotification_Skel TAO_ETCL DynamicAny CosNotification_Serv NotifyTests_Lib Bug_2415_Regression_Idl Bug_2415_Regression_Consumer
...
Bug_2561_Regression_Ntf_Cons: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming CosEvent CosEvent_Skel Svc_Utils IFR_Client DynamicInterface CosEvent_Serv CosNotification CosNotification_Skel TAO_ETCL DynamicAny CosNotification_Serv NotifyTests_Lib Bug_2561_Regression_Idl
...
Bug_2561_Regression_Ntf_Supp: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming CosEvent CosEvent_Skel Svc_Utils IFR_Client DynamicInterface CosEvent_Serv CosNotification CosNotification_Skel TAO_ETCL DynamicAny CosNotification_Serv NotifyTests_Lib Bug_2561_Regression_Idl Bug_2561_Regression_Ntf_Cons
...
Bug_2926_Regression_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming CosEvent CosEvent_Skel Svc_Utils IFR_Client DynamicInterface CosEvent_Serv CosNotification TAO_ETCL DynamicAny CosNotification_Serv Bug_2926_Regression_Lib
...
Bug_3252_Regression_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosEvent CosEvent_Skel Svc_Utils CosNotification CosNotification_Skel TAO_ETCL DynamicAny CosNotification_Serv Bug_3252_Regression_Lib
...
Bug_3646a_Regression_Ntf_Cons: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming CosEvent CosEvent_Skel Svc_Utils IFR_Client DynamicInterface CosEvent_Serv CosNotification CosNotification_Skel TAO_ETCL DynamicAny CosNotification_Serv NotifyTests_Lib
...
Bug_3646b_Regression_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming CosEvent CosEvent_Skel Svc_Utils IORTable CosNotification CosNotification_Skel TAO_ETCL DynamicAny CosNotification_Serv TAO_Notify_Service Bug_3646b_Regression_Lib
...
Bug_3646c_Regression_Ntf_Cons: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming CosEvent CosEvent_Skel Svc_Utils IFR_Client DynamicInterface CosEvent_Serv CosNotification CosNotification_Skel TAO_ETCL DynamicAny CosNotification_Serv NotifyTests_Lib
...
Bug_3646c_Regression_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming CosEvent CosEvent_Skel Svc_Utils IORTable CosNotification CosNotification_Skel TAO_ETCL DynamicAny CosNotification_Serv TAO_Notify_Service Bug_3646c_Regression_Lib
...
Bug_3646d_Regression_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming CosEvent CosEvent_Skel Svc_Utils IORTable CosNotification CosNotification_Skel TAO_ETCL DynamicAny CosNotification_Serv TAO_Notify_Service Bug_3646d_Regression_Lib
...
Bug_3663_Regression_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming CosEvent CosEvent_Skel Svc_Utils IORTable CosNotification CosNotification_Skel TAO_ETCL DynamicAny CosNotification_Serv TAO_Notify_Service Bug_3663_Regression_Lib
...
Bug_3688_Regression_Consumer: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming CosEvent CosEvent_Skel CosNotification CosNotification_Skel
...
Bug_3688_Regression_Supplier: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming CosEvent CosEvent_Skel CosNotification CosNotification_Skel
	$(KEEP_GOING)@cd orbsvcs/tests/Notify/Bug_3688_Regression && $(MAKE) -f GNUmakefile.Bug_3688_Regression_Supplier all

.PHONY: Bug_3688b_Lib
Bug_3688b_Lib: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming CosEvent CosEvent_Skel Svc_Utils IORTable CosNotification CosNotification_Skel TAO_ETCL DynamicAny CosNotification_Serv TAO_Notify_Service
	$(KEEP_GOING)@cd orbsvcs/tests/Notify/Bug_3688b_Regression && $(MAKE) -f GNUmakefile.Bug_3688b_Lib all

.PHONY: Bug_3688b_Server
Bug_3688b_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming CosEvent CosEvent_Skel Svc_Utils IORTable CosNotification CosNotification_Skel TAO_ETCL DynamicAny CosNotification_Serv TAO_Notify_Service Bug_3688b_Lib
	$(KEEP_GOING)@cd orbsvcs/tests/Notify/Bug_3688b_Regression && $(MAKE) -f GNUmakefile.Bug_3688b_Server all

.PHONY: Notify_Test_Destroy
Notify_Test_Destroy: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming CosEvent CosEvent_Skel Svc_Utils IORTable IFR_Client DynamicInterface CosEvent_Serv CosNotification CosNotification_Skel TAO_ETCL DynamicAny CosNotification_Serv NotifyTests_Lib
...
Discarding_Ntf_Struct_Supp: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming CosEvent CosEvent_Skel Svc_Utils IFR_Client DynamicInterface CosEvent_Serv CosNotification CosNotification_Skel TAO_ETCL DynamicAny CosNotification_Serv NotifyTests_Lib Discarding_Idl
...
Discarding_Ntf_Seq_Cons: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming CosEvent CosEvent_Skel Svc_Utils IFR_Client DynamicInterface CosEvent_Serv CosNotification CosNotification_Skel TAO_ETCL DynamicAny CosNotification_Serv NotifyTests_Lib Discarding_Idl Discarding_Ntf_Struct_Supp
...
Discarding_Ntf_Seq_Supp: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming CosEvent CosEvent_Skel Svc_Utils IFR_Client DynamicInterface CosEvent_Serv CosNotification CosNotification_Skel TAO_ETCL DynamicAny CosNotification_Serv NotifyTests_Lib Discarding_Idl Discarding_Ntf_Struct_Supp
...
Discarding_Ntf_Struct_Cons: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming CosEvent CosEvent_Skel Svc_Utils IFR_Client DynamicInterface CosEvent_Serv CosNotification CosNotification_Skel TAO_ETCL DynamicAny CosNotification_Serv NotifyTests_Lib Discarding_Idl Discarding_Ntf_Struct_Supp
	$(KEEP_GOING)@cd orbsvcs/tests/Notify/Discarding && $(MAKE) -f GNUmakefile.Discarding_Ntf_Struct_Cons all

.PHONY: Notify_Test_Driver
Notify_Test_Driver: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming CosEvent CosEvent_Skel Svc_Utils IFR_Client DynamicInterface CosEvent_Serv CosNotification CosNotification_Skel TAO_ETCL DynamicAny CosNotification_Serv NotifyTests_Lib
...
MonitorControl_Monitor: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming CosEvent CosEvent_Skel Svc_Utils IORTable CosNotification CosNotification_Skel TAO_ETCL DynamicAny CosNotification_Serv TAO_Monitor CosNotification_MC CosNotification_MC_Ext MonitorControl_Idl
	$(KEEP_GOING)@cd orbsvcs/tests/Notify/MC && $(MAKE) -f GNUmakefile.MonitorControl_Monitor all

.PHONY: MonitorControl_Consumer
MonitorControl_Consumer: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming CosEvent CosEvent_Skel Svc_Utils IFR_Client DynamicInterface CosEvent_Serv CosNotification CosNotification_Skel TAO_ETCL DynamicAny CosNotification_Serv NotifyTests_Lib MonitorControl_Idl MonitorControl_Monitor
	$(KEEP_GOING)@cd orbsvcs/tests/Notify/MC && $(MAKE) -f GNUmakefile.MonitorControl_Consumer all

.PHONY: MonitorControl_Supplier
MonitorControl_Supplier: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming CosEvent CosEvent_Skel Svc_Utils IFR_Client DynamicInterface CosEvent_Serv CosNotification CosNotification_Skel TAO_ETCL DynamicAny CosNotification_Serv NotifyTests_Lib MonitorControl_Idl MonitorControl_Monitor
...
MT_Dispatching_Ntf_Struct_Cons: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming CosEvent CosEvent_Skel Svc_Utils IFR_Client DynamicInterface CosEvent_Serv CosNotification CosNotification_Skel TAO_ETCL DynamicAny CosNotification_Serv NotifyTests_Lib MT_Dispatching_Idl
...
MT_Dispatching_Ntf_Struct_Supp: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming CosEvent CosEvent_Skel Svc_Utils IFR_Client DynamicInterface CosEvent_Serv CosNotification CosNotification_Skel TAO_ETCL DynamicAny CosNotification_Serv NotifyTests_Lib MT_Dispatching_Idl MT_Dispatching_Ntf_Struct_Cons
...
Ordering_Ntf_Seq_Cons: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming CosEvent CosEvent_Skel Svc_Utils IFR_Client DynamicInterface CosEvent_Serv CosNotification CosNotification_Skel TAO_ETCL DynamicAny CosNotification_Serv NotifyTests_Lib Ordering_Idl
	$(KEEP_GOING)@cd orbsvcs/tests/Notify/Ordering && $(MAKE) -f GNUmakefile.Ordering_Ntf_Seq_Cons all

.PHONY: Ordering_Ntf_Seq_Supp
Ordering_Ntf_Seq_Supp: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming CosEvent CosEvent_Skel Svc_Utils IFR_Client DynamicInterface CosEvent_Serv CosNotification CosNotification_Skel TAO_ETCL DynamicAny CosNotification_Serv NotifyTests_Lib Ordering_Idl Ordering_Ntf_Seq_Cons
	$(KEEP_GOING)@cd orbsvcs/tests/Notify/Ordering && $(MAKE) -f GNUmakefile.Ordering_Ntf_Seq_Supp all

.PHONY: Ordering_Ntf_Struct_Cons
Ordering_Ntf_Struct_Cons: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming CosEvent CosEvent_Skel Svc_Utils IFR_Client DynamicInterface CosEvent_Serv CosNotification CosNotification_Skel TAO_ETCL DynamicAny CosNotification_Serv NotifyTests_Lib Ordering_Idl Ordering_Ntf_Seq_Cons
...
Ordering_Ntf_Struct_Supp: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming CosEvent CosEvent_Skel Svc_Utils IFR_Client DynamicInterface CosEvent_Serv CosNotification CosNotification_Skel TAO_ETCL DynamicAny CosNotification_Serv NotifyTests_Lib Ordering_Idl Ordering_Ntf_Seq_Cons Ordering_Ntf_Seq_Supp
	$(KEEP_GOING)@cd orbsvcs/tests/Notify/Ordering && $(MAKE) -f GNUmakefile.Ordering_Ntf_Struct_Supp all

.PHONY: consumer
consumer: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming CosEvent CosEvent_Skel CosNotification CosNotification_Skel
	$(KEEP_GOING)@cd orbsvcs/tests/Notify/Persistent_Filter && $(MAKE) -f GNUmakefile.consumer all

.PHONY: supplier
supplier: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming CosEvent CosEvent_Skel CosNotification CosNotification_Skel consumer
	$(KEEP_GOING)@cd orbsvcs/tests/Notify/Persistent_Filter && $(MAKE) -f GNUmakefile.supplier all

.PHONY: Persistent_POA_Notify_Supplier
Persistent_POA_Notify_Supplier: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming CosEvent CosEvent_Skel Svc_Utils IFR_Client DynamicInterface CosEvent_Serv CosNotification CosNotification_Skel TAO_ETCL DynamicAny CosNotification_Serv NotifyTests_Lib
	$(KEEP_GOING)@cd orbsvcs/tests/Notify/Persistent_POA && $(MAKE) -f GNUmakefile.Persistent_POA_Notify_Supplier all

.PHONY: PlugTop_Lib
PlugTop_Lib: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming CosEvent CosEvent_Skel Svc_Utils IFR_Client DynamicInterface CosEvent_Serv CosNotification TAO_ETCL DynamicAny CosNotification_Serv
	$(KEEP_GOING)@cd orbsvcs/tests/Notify/PluggableTopology && $(MAKE) -f GNUmakefile.PlugTop_Lib all

.PHONY: PlugTop
PlugTop: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming CosEvent CosEvent_Skel Svc_Utils IFR_Client DynamicInterface CosEvent_Serv CosNotification TAO_ETCL DynamicAny CosNotification_Serv PlugTop_Lib
	$(KEEP_GOING)@cd orbsvcs/tests/Notify/PluggableTopology && $(MAKE) -f GNUmakefile.PlugTop all

.PHONY: RT_Notify_lib
RT_Notify_lib: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging RTCORBA RTPortableServer CosNaming CosEvent CosEvent_Skel Svc_Utils IFR_Client DynamicInterface CosEvent_Serv CosNotification CosNotification_Skel TAO_ETCL DynamicAny CosNotification_Serv NotifyTests_Lib
	$(KEEP_GOING)@cd orbsvcs/tests/Notify/RT_lib && $(MAKE) -f GNUmakefile.RT_Notify_lib all

.PHONY: Reconnecting_Consumer
Reconnecting_Consumer: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming CosEvent CosEvent_Skel Svc_Utils IFR_Client DynamicInterface CosEvent_Serv CosNotification CosNotification_Skel TAO_ETCL DynamicAny CosNotification_Serv NotifyTests_Lib
	$(KEEP_GOING)@cd orbsvcs/tests/Notify/Reconnecting && $(MAKE) -f GNUmakefile.Reconnecting_Consumer all

.PHONY: Reconnecting_Supplier
Reconnecting_Supplier: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming CosEvent CosEvent_Skel Svc_Utils IFR_Client DynamicInterface CosEvent_Serv CosNotification CosNotification_Skel TAO_ETCL DynamicAny CosNotification_Serv NotifyTests_Lib
...
Seq_Multi_ETCL_Filter_Ntf_Seq_Cons: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming CosEvent CosEvent_Skel Svc_Utils IFR_Client DynamicInterface CosEvent_Serv CosNotification CosNotification_Skel TAO_ETCL DynamicAny CosNotification_Serv NotifyTests_Lib Seq_Multi_ETCL_Filter_Idl
...
Seq_Multi_ETCL_Filter_Ntf_Seq_Supp: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming CosEvent CosEvent_Skel Svc_Utils IFR_Client DynamicInterface CosEvent_Serv CosNotification CosNotification_Skel TAO_ETCL DynamicAny CosNotification_Serv NotifyTests_Lib Seq_Multi_ETCL_Filter_Idl Seq_Multi_ETCL_Filter_Ntf_Seq_Cons
...
Seq_Multi_Filter_Ntf_Seq_Cons: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming CosEvent CosEvent_Skel Svc_Utils IFR_Client DynamicInterface CosEvent_Serv CosNotification CosNotification_Skel TAO_ETCL DynamicAny CosNotification_Serv NotifyTests_Lib Seq_Multi_Filter_Idl
...
Seq_Multi_Filter_Ntf_Seq_Supp: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming CosEvent CosEvent_Skel Svc_Utils IFR_Client DynamicInterface CosEvent_Serv CosNotification CosNotification_Skel TAO_ETCL DynamicAny CosNotification_Serv NotifyTests_Lib Seq_Multi_Filter_Idl Seq_Multi_Filter_Ntf_Seq_Cons
...
Struct_Filter_Ntf_Struct_Supp: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming CosEvent CosEvent_Skel Svc_Utils IFR_Client DynamicInterface CosEvent_Serv CosNotification CosNotification_Skel TAO_ETCL DynamicAny CosNotification_Serv NotifyTests_Lib Struct_Filter_Idl
...
Struct_Filter_Ntf_Struct_Cons: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming CosEvent CosEvent_Skel Svc_Utils IFR_Client DynamicInterface CosEvent_Serv CosNotification CosNotification_Skel TAO_ETCL DynamicAny CosNotification_Serv NotifyTests_Lib Struct_Filter_Idl Struct_Filter_Ntf_Struct_Supp
...
Struct_Multi_Filter_Ntf_Struct_Supp: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming CosEvent CosEvent_Skel Svc_Utils IFR_Client DynamicInterface CosEvent_Serv CosNotification CosNotification_Skel TAO_ETCL DynamicAny CosNotification_Serv NotifyTests_Lib Struct_Multi_Filter_Idl
...
Struct_Multi_Filter_Ntf_Struct_Cons: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming CosEvent CosEvent_Skel Svc_Utils IFR_Client DynamicInterface CosEvent_Serv CosNotification CosNotification_Skel TAO_ETCL DynamicAny CosNotification_Serv NotifyTests_Lib Struct_Multi_Filter_Idl Struct_Multi_Filter_Ntf_Struct_Supp
...
TAO_RT_NotifyTests_Filter: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging RTCORBA CosNaming CosEvent CosEvent_Skel Svc_Utils IORTable IFR_Client DynamicInterface CosEvent_Serv CosNotification CosNotification_Skel TAO_ETCL DynamicAny CosNotification_Serv
...
Timeout_Consumer: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming CosEvent CosEvent_Skel Svc_Utils IFR_Client DynamicInterface CosEvent_Serv CosNotification CosNotification_Skel TAO_ETCL DynamicAny CosNotification_Serv NotifyTests_Lib Tao__Timeout_Idl
	$(KEEP_GOING)@cd orbsvcs/tests/Notify/Timeout && $(MAKE) -f GNUmakefile.Timeout_Consumer all

.PHONY: Timeout_Supplier
Timeout_Supplier: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming CosEvent CosEvent_Skel Svc_Utils IFR_Client DynamicInterface CosEvent_Serv CosNotification CosNotification_Skel TAO_ETCL DynamicAny CosNotification_Serv NotifyTests_Lib Tao__Timeout_Idl Timeout_Consumer
...
XML_Persistence: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming CosEvent CosEvent_Skel Svc_Utils IFR_Client DynamicInterface CosEvent_Serv CosNotification TAO_ETCL DynamicAny CosNotification_Serv
...
Filter_Notify_Perf_Sequence_Consumer: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming CosEvent CosEvent_Skel Svc_Utils IFR_Client DynamicInterface CosEvent_Serv CosNotification CosNotification_Skel TAO_ETCL DynamicAny CosNotification_Serv NotifyTests_Lib Filter_Idl
...
Filter_Ntf_Perf_Seq_Supp: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming CosEvent CosEvent_Skel Svc_Utils IFR_Client DynamicInterface CosEvent_Serv CosNotification CosNotification_Skel TAO_ETCL DynamicAny CosNotification_Serv NotifyTests_Lib Filter_Idl Filter_Notify_Perf_Sequence_Consumer
...
Filter_Ntf_Perf_Struct_Cons: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming CosEvent CosEvent_Skel Svc_Utils IFR_Client DynamicInterface CosEvent_Serv CosNotification CosNotification_Skel TAO_ETCL DynamicAny CosNotification_Serv NotifyTests_Lib Filter_Idl Filter_Notify_Perf_Sequence_Consumer
...
Filter_Ntf_Perf_Struct_Supp: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming CosEvent CosEvent_Skel Svc_Utils IFR_Client DynamicInterface CosEvent_Serv CosNotification CosNotification_Skel TAO_ETCL DynamicAny CosNotification_Serv NotifyTests_Lib Filter_Idl Filter_Notify_Perf_Sequence_Consumer Filter_Ntf_Perf_Seq_Supp
...
RedGreen_Ntf_Perf_RedGreen: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming CosEvent CosEvent_Skel Svc_Utils IFR_Client DynamicInterface CosEvent_Serv CosNotification CosNotification_Skel TAO_ETCL DynamicAny CosNotification_Serv NotifyTests_Lib
...
Throughput_Ntf_Perf_Throughput: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming CosEvent CosEvent_Skel Svc_Utils Strategies IFR_Client DynamicInterface CosEvent_Serv CosNotification CosNotification_Skel TAO_ETCL DynamicAny CosNotification_Serv NotifyTests_Lib
...
Property_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer CosNaming TAO_Utils CosProperty
	$(KEEP_GOING)@cd orbsvcs/tests/Property && $(MAKE) -f GNUmakefile.Property_Client all

.PHONY: Property_Server
Property_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming CosProperty CosProperty_Skel CosProperty_Serv
	$(KEEP_GOING)@cd orbsvcs/tests/Property && $(MAKE) -f GNUmakefile.Property_Server all

.PHONY: Redundant_Naming_Client
Redundant_Naming_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming
	$(KEEP_GOING)@cd orbsvcs/tests/Redundant_Naming && $(MAKE) -f GNUmakefile.Redundant_Naming_Client all

.PHONY: Sched
Sched: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming Svc_Utils RTSched
	$(KEEP_GOING)@cd orbsvcs/tests/Sched && $(MAKE) -f GNUmakefile.Sched all

.PHONY: Sched_Conf
Sched_Conf: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming Svc_Utils RTSched
...
Big_Request_Security_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer Big_Request_Idl
...
Big_Request_Security_Client: TAO_IDL_EXE TAO Codeset Big_Request_Idl Big_Request_Security_Server
...
Bug_2908_Regression_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer PI_Server Security SSLIOP Bug_2908_Regression_Idl
...
Bug_2908_Regression_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer PI_Server Security SSLIOP Bug_2908_Regression_Idl Bug_2908_Regression_Client
...
Security_Crash_Test_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer PI_Server Security SSLIOP Security_Crash_Test_Idl
...
Security_Crash_Test_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer PI_Server Security SSLIOP Security_Crash_Test_Idl Security_Crash_Test_Client
...
MT_BiDir_SSL_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer BiDir_GIOP MT_BiDir_SSL_Idl
	$(KEEP_GOING)@cd orbsvcs/tests/Security/MT_BiDir_SSL && $(MAKE) -f GNUmakefile.MT_BiDir_SSL_Client all

.PHONY: MT_BiDir_SSL_Server
MT_BiDir_SSL_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer BiDir_GIOP MT_BiDir_SSL_Idl MT_BiDir_SSL_Client
...
MT_SSLIOP_Security_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode MT_SSLIOP_Idl
...
MT_SSLIOP_Security_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer IORTable MT_SSLIOP_Idl MT_SSLIOP_Security_Client
...
Secure_Invocation_Security_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer PI_Server Security SSLIOP Secure_Invocation_Idl
...
Secure_Invocation_Security_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Security Secure_Invocation_Idl Secure_Invocation_Security_Server
...
mixed_security_security_server: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer PI_Server Security SSLIOP mixed_security_idl
...
mixed_security_security_client: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Security mixed_security_idl mixed_security_security_server
...
Ssliop_CSD_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Security Ssliop_CSD_Idl
	$(KEEP_GOING)@cd orbsvcs/tests/Security/ssliop_CSD && $(MAKE) -f GNUmakefile.Ssliop_CSD_Client all

.PHONY: Ssliop_CSD_Server
Ssliop_CSD_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Security Ssliop_CSD_Idl Ssliop_CSD_Client
	$(KEEP_GOING)@cd orbsvcs/tests/Security/ssliop_CSD && $(MAKE) -f GNUmakefile.Ssliop_CSD_Server all

.PHONY: Corbaloc_Ssliop_Client
Corbaloc_Ssliop_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer CosNaming TAO_Utils
...
Simple_Naming_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer CosNaming TAO_Utils
	$(KEEP_GOING)@cd orbsvcs/tests/Simple_Naming && $(MAKE) -f GNUmakefile.Simple_Naming_Client all

.PHONY: Time_Orbsvcs_Client
Time_Orbsvcs_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode CosNaming CosTime
	$(KEEP_GOING)@cd orbsvcs/tests/Time && $(MAKE) -f GNUmakefile.Time_Orbsvcs_Client all

.PHONY: Trading_Test_Lib
Trading_Test_Lib: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer CosNaming Svc_Utils IORTable TAO_Utils DynamicAny CosTrading CosTrading_Skel CosTrading_Serv
	$(KEEP_GOING)@cd orbsvcs/tests/Trading && $(MAKE) -f GNUmakefile.Trading_Test_Lib all

.PHONY: Trading_Colocated_Test
Trading_Colocated_Test: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer CosNaming Svc_Utils IORTable TAO_Utils DynamicAny CosTrading CosTrading_Skel CosTrading_Serv Trading_Test_Lib
	$(KEEP_GOING)@cd orbsvcs/tests/Trading && $(MAKE) -f GNUmakefile.Trading_Colocated_Test all

.PHONY: Trading_Export_Test
Trading_Export_Test: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer CosNaming Svc_Utils IORTable TAO_Utils DynamicAny CosTrading CosTrading_Skel CosTrading_Serv Trading_Test_Lib
	$(KEEP_GOING)@cd orbsvcs/tests/Trading && $(MAKE) -f GNUmakefile.Trading_Export_Test all

.PHONY: Trading_Import_Test
Trading_Import_Test: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer CosNaming Svc_Utils IORTable TAO_Utils DynamicAny CosTrading CosTrading_Skel CosTrading_Serv Trading_Test_Lib
...
ior_corbaname_client: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming ior_corbaname_idl
	$(KEEP_GOING)@cd orbsvcs/tests/ior_corbaname && $(MAKE) -f GNUmakefile.ior_corbaname_client all

.PHONY: ior_corbaname_server
ior_corbaname_server: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming ior_corbaname_idl ior_corbaname_client
...
.PHONY: Control
Control: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming IORTable TAO_ETCL TAO_Monitor CosNotification_MC
	$(KEEP_GOING)@cd orbsvcs/tests/unit/Notify/MC/Control && $(MAKE) -f GNUmakefile.Control all

.PHONY: MonitorControlExt
MonitorControlExt: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming CosEvent CosEvent_Skel Svc_Utils IORTable CosNotification CosNotification_Skel TAO_ETCL DynamicAny CosNotification_Serv TAO_Monitor CosNotification_MC CosNotification_MC_Ext
...
MonitorManager_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming IORTable TAO_ETCL TAO_Monitor CosNotification_MC
...
NotificationServiceMonitor: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming IORTable TAO_ETCL TAO_Monitor CosNotification_MC
	$(KEEP_GOING)@cd orbsvcs/tests/unit/Notify/MC/NotificationServiceMonitor && $(MAKE) -f GNUmakefile.NotificationServiceMonitor all

.PHONY: Statistic
Statistic: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming IORTable TAO_ETCL TAO_Monitor CosNotification_MC
	$(KEEP_GOING)@cd orbsvcs/tests/unit/Notify/MC/Statistic && $(MAKE) -f GNUmakefile.Statistic all

.PHONY: Statistic_Registry
Statistic_Registry: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming IORTable TAO_ETCL TAO_Monitor CosNotification_MC
...
Callback_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging Strategies Callback_Perf_IDL
	$(KEEP_GOING)@cd performance-tests/Callback && $(MAKE) -f GNUmakefile.Callback_Server all

.PHONY: Callback_Client
Callback_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging Strategies Callback_Perf_IDL Callback_Server
...
IDL_Cubit_Collocation: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer Strategies TAO_Utils IDL_Cubit_IDL
	$(KEEP_GOING)@cd performance-tests/Cubit/TAO/IDL_Cubit && $(MAKE) -f GNUmakefile.IDL_Cubit_Collocation all

.PHONY: IDL_Cubit_Server
IDL_Cubit_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer Strategies TAO_Utils IDL_Cubit_IDL IDL_Cubit_Collocation
...
IDL_Cubit_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI Strategies IDL_Cubit_IDL IDL_Cubit_Collocation
...
Single_Threaded_AMH_Latency_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging Strategies Single_Threaded_AMH_Latency_Idl
...
Single_Threaded_AMH_Latency_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging Strategies Single_Threaded_AMH_Latency_Idl Single_Threaded_AMH_Latency_Server
...
AMI_Latency_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging Strategies AMI_Latency_Idl
	$(KEEP_GOING)@cd performance-tests/Latency/AMI && $(MAKE) -f GNUmakefile.AMI_Latency_Server all

.PHONY: AMI_Latency_Client
AMI_Latency_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging Strategies AMI_Latency_Idl AMI_Latency_Server
...
Deferred_Latency_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging Strategies DynamicInterface Deferred_Latency_Idl
...
Deferred_Latency_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer Strategies Deferred_Latency_Idl Deferred_Latency_Client
...
Single_Threaded_Latency_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI Strategies Single_Threaded_Latency_Idl
...
Single_Threaded_Latency_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer Strategies Single_Threaded_Latency_Idl Single_Threaded_Latency_Client
...
Demux_Poa_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming Demux_Poa_Idl
	$(KEEP_GOING)@cd performance-tests/POA/Demux && $(MAKE) -f GNUmakefile.Demux_Poa_Client all

.PHONY: Demux_Poa_Server
Demux_Poa_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CosNaming Demux_Poa_Idl Demux_Poa_Client
...
DII_Sequence_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer Strategies DII_Sequence_Idl
	$(KEEP_GOING)@cd performance-tests/Sequence_Latency/DII && $(MAKE) -f GNUmakefile.DII_Sequence_Server all

.PHONY: DII_Sequence_Client
DII_Sequence_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging Strategies DynamicInterface DII_Sequence_Idl DII_Sequence_Server
...
DSI_Sequence_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI Strategies DSI_Idl
	$(KEEP_GOING)@cd performance-tests/Sequence_Latency/DSI && $(MAKE) -f GNUmakefile.DSI_Sequence_Client all

.PHONY: DSI_Sequence_Server
DSI_Sequence_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging Strategies DynamicInterface DSI_Idl DSI_Sequence_Client
...
Single_Threaded_Sequence_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer Strategies Single_Threaded_Sequence_Idl
...
Single_Threaded_Sequence_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI Strategies Single_Threaded_Sequence_Idl Single_Threaded_Sequence_Server
...
Thread_Pool_Sequence_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer Strategies Thread_Pool_Sequence_Idl
...
Thread_Pool_Sequence_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI Strategies Thread_Pool_Sequence_Idl Thread_Pool_Sequence_Server
...
AMH_Exceptions_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging Strategies AMH_Exceptions_Idl
	$(KEEP_GOING)@cd tests/AMH_Exceptions && $(MAKE) -f GNUmakefile.AMH_Exceptions_Server all

.PHONY: AMH_Exceptions_Client
AMH_Exceptions_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging Strategies AMH_Exceptions_Idl AMH_Exceptions_Server
...
.PHONY: AMI_Server
AMI_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging AMI_Idl
	$(KEEP_GOING)@cd tests/AMI && $(MAKE) -f GNUmakefile.AMI_Server all

.PHONY: AMI_Client
AMI_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging AMI_Idl AMI_Server
	$(KEEP_GOING)@cd tests/AMI && $(MAKE) -f GNUmakefile.AMI_Client all

.PHONY: AMI_Simple_Client
AMI_Simple_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging AMI_Idl AMI_Server
...
BiDirectional_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer BiDir_GIOP BiDirectional_Idl
	$(KEEP_GOING)@cd tests/BiDirectional && $(MAKE) -f GNUmakefile.BiDirectional_Client all

.PHONY: BiDirectional_Server
BiDirectional_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer BiDir_GIOP BiDirectional_Idl BiDirectional_Client
...
BiDir_DelayedUpcall_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer BiDir_GIOP BiDir_DelayedUpcall_Idl
...
BiDir_DelayedUpcall_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer BiDir_GIOP BiDir_DelayedUpcall_Idl BiDir_DelayedUpcall_Client
...
Big_AMI_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging Big_AMI_Idl
	$(KEEP_GOING)@cd tests/Big_AMI && $(MAKE) -f GNUmakefile.Big_AMI_Server all

.PHONY: Big_AMI_Client
Big_AMI_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging Big_AMI_Idl Big_AMI_Server
...
Blocking_Sync_None_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging Blocking_Sync_None_Idl
	$(KEEP_GOING)@cd tests/Blocking_Sync_None && $(MAKE) -f GNUmakefile.Blocking_Sync_None_Server all

.PHONY: Blocking_Sync_None_Client
Blocking_Sync_None_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging Blocking_Sync_None_Idl Blocking_Sync_None_Server
...
Bug_1254_Regression_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer Bug_1254_Regression_Idl
...
Bug_1254_Regression_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer Bug_1254_Regression_Idl Bug_1254_Regression_Client
...
Bug_1476_Regression_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging Bug_1476_Regression_Idl
...
Bug_1476_Regression_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging Bug_1476_Regression_Idl Bug_1476_Regression_Server
...
Bug_1482_Regression_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging IORTable Bug_1482_Regression_Idl
...
Bug_1482_Regression_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging Bug_1482_Regression_Idl Bug_1482_Regression_Server
...
Bug_1495_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer Bug_1495_Idl
	$(KEEP_GOING)@cd tests/Bug_1495_Regression && $(MAKE) -f GNUmakefile.Bug_1495_Client all

.PHONY: Bug_1495_Server
Bug_1495_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer PI_Server Bug_1495_Idl Bug_1495_Client
...
Bug_1568_Regression_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging Bug_1568_Regression_Idl
...
Bug_1568_Regression_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging Bug_1568_Regression_Idl Bug_1568_Regression_Server
...
Bug_2186_Regression_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer Strategies Bug_2186_Regression_Idl
...
Bug_2186_Regression_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer Strategies Bug_2186_Regression_Idl Bug_2186_Regression_Server
...
Bug_2289_Regression_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer IORTable Bug_2289_Regression_Idl
...
Bug_2289_Regression_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer IORTable Bug_2289_Regression_Idl Bug_2289_Regression_Client
...
Bug_2345_Regression_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer ImR_Client
...
Bug_2356_Regression_Simple_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging Bug_2356_Regression_Idl
...
Bug_2356_Regression_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging Bug_2356_Regression_Idl Bug_2356_Regression_Simple_Client
...
Bug_2494_Regression_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer Bug_2494_Regression_Idl
...
Bug_2494_Regression_Client: TAO_IDL_EXE TAO Codeset Bug_2494_Regression_Idl Bug_2494_Regression_Server
...
Bug_2503_Regression_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging Bug_2503_Regression_Idl
...
Bug_2503_Regression_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging Bug_2503_Regression_Idl Bug_2503_Regression_Server
...
Bug_2593_Regression_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer Strategies Bug_2593_Regression_Idl
...
Bug_2593_Regression_Client: TAO_IDL_EXE TAO Codeset Bug_2593_Regression_Idl Bug_2593_Regression_Server
...
Bug_2678_Regression_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode Bug_2678_Regression_Idl
...
Bug_2678_Regression_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer Bug_2678_Regression_Idl Bug_2678_Regression_Client
...
Bug_2804_Regression_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype PortableServer Bug_2804_Regression_Idl
...
Bug_2804_Regression_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype IFR_Client TypeCodeFactory Bug_2804_Regression_Idl Bug_2804_Regression_Server
...
Bug_2935_Regression_Source: TAO_IDL_EXE TAO Codeset Bug_2935_Regression_IDL
...
Bug_2935_Regression_Middle: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer Bug_2935_Regression_IDL Bug_2935_Regression_Source
	$(KEEP_GOING)@cd tests/Bug_2935_Regression && $(MAKE) -f GNUmakefile.Bug_2935_Regression_Middle all

.PHONY: Bug_2935_Regression_Sink
Bug_2935_Regression_Sink: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer Bug_2935_Regression_IDL Bug_2935_Regression_Source Bug_2935_Regression_Middle
...
Bug_3000_Regression_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging Bug_3000_Regression_Idl
...
Bug_3000_Regression_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging Bug_3000_Regression_Idl Bug_3000_Regression_Server
...
Bug_3108_Regression_Client: TAO_IDL_EXE TAO Codeset Bug_3108_Regression_Idl
...
Bug_3108_Regression_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer Bug_3108_Regression_Idl Bug_3108_Regression_Client
...
Bug_3276_Regression_Client: TAO_IDL_EXE TAO Codeset Bug_3276_Regression_Idl
...
Bug_3276_Regression_Manager: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer Bug_3276_Regression_Idl Bug_3276_Regression_Client
...
Bug3333_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer IORTable Bug3333_Idl
	$(KEEP_GOING)@cd tests/Bug_3333_Regression && $(MAKE) -f GNUmakefile.Bug3333_Server all

.PHONY: Bug3333_Client
Bug3333_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging Bug3333_Idl Bug3333_Server
...
Bug_3479_Regression_Client: TAO_IDL_EXE TAO Codeset Bug_3479_Regression_Idl
...
Bug_3479_Regression_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer Bug_3479_Regression_Idl Bug_3479_Regression_Client
...
Bug_3531_Regression_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging IORTable Bug_3531_Regression_Idl
...
Bug_3531_Regression_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging IORTable Bug_3531_Regression_Idl Bug_3531_Regression_Client
...
Bug_3543_Regression_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer Bug_3543_Regression_Idl
...
Bug_3543_Regression_Master: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer Bug_3543_Regression_Idl Bug_3543_Regression_Server
...
Bug_3547_Regression_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI Strategies Bug_3547_Regression_Idl
...
Bug_3547_Regression_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer IORTable Strategies Bug_3547_Regression_Idl Bug_3547_Regression_Client
...
Bug_3567_Regression_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging Bug_3567_Regression_Idl
...
Bug_3567_Regression_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging Bug_3567_Regression_Idl Bug_3567_Regression_Server
...
Bug_3636_Regression_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer Bug_3636_Regression_Idl
...
Bug_3636_Regression_Client: TAO_IDL_EXE TAO Codeset Bug_3636_Regression_Idl Bug_3636_Regression_Server
...
Bug_3647_Regression_Backend: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer Strategies TAO_Utils Bug_3647_Regression_Idl
...
Bug_3647_Regression_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging Strategies TAO_Utils Bug_3647_Regression_Idl Bug_3647_Regression_Backend
...
Bug_3647_Regression_Middle: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging Strategies TAO_Utils Bug_3647_Regression_Idl Bug_3647_Regression_Backend
...
Bug_3672_Regression_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging Bug_3672_Regression_Idl
...
Bug_3672_Regression_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging Bug_3672_Regression_Idl Bug_3672_Regression_Client
...
Bug_3748_Regression_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer Bug_3748_Regression_Idl
...
Bug_3748_Regression_Client: TAO_IDL_EXE TAO Codeset Bug_3748_Regression_Idl Bug_3748_Regression_Server
...
Bug_3766_Regression_Client: TAO_IDL_EXE TAO Codeset Bug_3766_Regression_Idl
...
Bug_3766_Regression_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer Bug_3766_Regression_Idl Bug_3766_Regression_Client
...
Bug_3790_Regression_Server2: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer IORTable Bug_3790_Regression_Idl
...
Bug_3790_Regression_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer Bug_3790_Regression_Idl Bug_3790_Regression_Server2
...
COIOP_Simple_Test: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer Strategies COIOP_Tests_Idl
	$(KEEP_GOING)@cd tests/COIOP && $(MAKE) -f GNUmakefile.COIOP_Simple_Test all

.PHONY: COIOP_Test
COIOP_Test: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer Strategies COIOP_Tests_Idl COIOP_Simple_Test
...
CSD_Collocation: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer Strategies CSD_Framework CSD_ThreadPool
...
Cache_Growth_Test_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode Cache_Growth_Test_Idl
	$(KEEP_GOING)@cd tests/Cache_Growth_Test && $(MAKE) -f GNUmakefile.Cache_Growth_Test_Client all

.PHONY: Cache_Growth_Test_Server
Cache_Growth_Test_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer Cache_Growth_Test_Idl Cache_Growth_Test_Client
...
Client_Leaks_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer Client_Leaks_Idl Client_Leaks_Client Client_Leaks_Child
...
CollocationLockup: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CollocationLockup_Idl
...
CollocationLockup_SimpleNamingService: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer CollocationLockup_Idl CollocationLockup
...
Connect_Strategy_Test_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer Connect_Strategy_Test_Idl
...
Connect_Strategy_Test_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode Connect_Strategy_Test_Idl Connect_Strategy_Test_Server
...
Crash_On_Write_Client: TAO_IDL_EXE TAO Codeset Crash_On_Write_Idl
	$(KEEP_GOING)@cd tests/Crash_On_Write && $(MAKE) -f GNUmakefile.Crash_On_Write_Client all

.PHONY: Crash_On_Write_Server
Crash_On_Write_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer Crash_On_Write_Idl Crash_On_Write_Client
...
Crashed_Callback_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging Crashed_Callback_Idl
	$(KEEP_GOING)@cd tests/Crashed_Callback && $(MAKE) -f GNUmakefile.Crashed_Callback_Server all

.PHONY: Crashed_Callback_Client
Crashed_Callback_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging Crashed_Callback_Idl Crashed_Callback_Server
...
DII_AMI_Forward_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging DynamicInterface DII_AMI_Forward_Idl
	$(KEEP_GOING)@cd tests/DII_AMI_Forward && $(MAKE) -f GNUmakefile.DII_AMI_Forward_Client all

.PHONY: DII_AMI_Forward_Server
DII_AMI_Forward_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging PI_Server DII_AMI_Forward_Idl DII_AMI_Forward_Client
...
DSI_AMH_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging DynamicInterface DSI_AMH_Idl
	$(KEEP_GOING)@cd tests/DSI_AMH && $(MAKE) -f GNUmakefile.DSI_AMH_Server all

.PHONY: DSI_AMH_Client
DSI_AMH_Client: TAO_IDL_EXE TAO Codeset DSI_AMH_Idl DSI_AMH_Server
...
DSI_Gateway_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging DynamicInterface DSI_Gateway_Idl
	$(KEEP_GOING)@cd tests/DSI_Gateway && $(MAKE) -f GNUmakefile.DSI_Gateway_Server all

.PHONY: DSI_Gateway_Client
DSI_Gateway_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging DynamicInterface DSI_Gateway_Idl DSI_Gateway_Server
	$(KEEP_GOING)@cd tests/DSI_Gateway && $(MAKE) -f GNUmakefile.DSI_Gateway_Client all

.PHONY: DSI_Gateway_Gateway
DSI_Gateway_Gateway: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging DynamicInterface DSI_Gateway_Idl DSI_Gateway_Server
...
diffserv_client: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer DiffServPolicy diffserv_idl
	$(KEEP_GOING)@cd tests/DiffServ && $(MAKE) -f GNUmakefile.diffserv_client all

.PHONY: diffserv_server
diffserv_server: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer DiffServPolicy diffserv_idl diffserv_client
...
Explicit_Event_Loop_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode Explicit_Event_Loop_Idl
...
Explicit_Event_Loop_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer Explicit_Event_Loop_Idl Explicit_Event_Loop_Client
...
.PHONY: Faults_Client
Faults_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer Faults_Idl
	$(KEEP_GOING)@cd tests/Faults && $(MAKE) -f GNUmakefile.Faults_Client all

.PHONY: Faults_Middle
Faults_Middle: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer Faults_Idl Faults_Client
...
.PHONY: Faults_Server
Faults_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer Faults_Idl Faults_Client
...
ForwardUponObjectNotExist_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode ForwardUponObjectNotExist_Idl
...
ForwardUponObjectNotExist_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer IORTable ForwardUponObjectNotExist_Idl ForwardUponObjectNotExist_Client
...
Forwarding_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer IORTable Forwarding_Idl
	$(KEEP_GOING)@cd tests/Forwarding && $(MAKE) -f GNUmakefile.Forwarding_Server all

.PHONY: Forwarding_Client
Forwarding_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode Forwarding_Idl Forwarding_Server
...
.PHONY: Hello_Client
Hello_Client: TAO_IDL_EXE TAO Codeset Hello_Idl
	$(KEEP_GOING)@cd tests/Hello && $(MAKE) -f GNUmakefile.Hello_Client all

.PHONY: Hello_Server
Hello_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer Hello_Idl Hello_Client
...
ICMG_Any_Bug_Hello_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer ICMG_Any_Bug_Hello_IDL
	$(KEEP_GOING)@cd tests/ICMG_Any_Bug && $(MAKE) -f GNUmakefile.ICMG_Any_Bug_Hello_Server all

.PHONY: ICMG_Any_Bug_Hello_Client
ICMG_Any_Bug_Hello_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging IFR_Client DynamicInterface ICMG_Any_Bug_Hello_IDL ICMG_Any_Bug_Hello_Server
...
InheritedOp_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer InheritedOp_Idl
	$(KEEP_GOING)@cd tests/IDL_Inherited_Operation && $(MAKE) -f GNUmakefile.InheritedOp_Server all

.PHONY: InheritedOp_Client
InheritedOp_Client: TAO_IDL_EXE TAO Codeset InheritedOp_Idl InheritedOp_Server
...
Leader_Followers_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer Strategies Leader_Followers_Idl
	$(KEEP_GOING)@cd tests/Leader_Followers && $(MAKE) -f GNUmakefile.Leader_Followers_Server all

.PHONY: Leader_Followers_Client
Leader_Followers_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI Strategies Leader_Followers_Idl Leader_Followers_Server
...
LongDoubleTest_Client: TAO_IDL_EXE TAO Codeset LongDoubleTest_Idl
	$(KEEP_GOING)@cd tests/LongDouble && $(MAKE) -f GNUmakefile.LongDoubleTest_Client all

.PHONY: LongDoubleTest_Server
LongDoubleTest_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer LongDoubleTest_Idl LongDoubleTest_Client
...
LongUpcalls_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging LongUpcalls_Idl
	$(KEEP_GOING)@cd tests/LongUpcalls && $(MAKE) -f GNUmakefile.LongUpcalls_Server all

.PHONY: LongUpcalls_Client
LongUpcalls_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging LongUpcalls_Idl LongUpcalls_Server
	$(KEEP_GOING)@cd tests/LongUpcalls && $(MAKE) -f GNUmakefile.LongUpcalls_Client all

.PHONY: LongUpcalls_AMI_Client
LongUpcalls_AMI_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging LongUpcalls_Idl LongUpcalls_Server LongUpcalls_Client
	$(KEEP_GOING)@cd tests/LongUpcalls && $(MAKE) -f GNUmakefile.LongUpcalls_AMI_Client all

.PHONY: LongUpcalls_AMI_Server
LongUpcalls_AMI_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging LongUpcalls_Idl LongUpcalls_Server
...
MProfile_Connection_Timeout_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging IORManipulation MProfile_Connection_Timeout_Idl
...
MProfile_Connection_Timeout_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging IORManipulation MProfile_Connection_Timeout_Idl MProfile_Connection_Timeout_Client
...
MProfile_Forwarding_Manager: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer IORManipulation MProfile_Forwarding_Idl
...
MProfile_Forwarding_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode MProfile_Forwarding_Idl MProfile_Forwarding_Manager
...
MProfile_Forwarding_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer MProfile_Forwarding_Idl MProfile_Forwarding_Manager
...
MT_BiDir_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer BiDir_GIOP MT_BiDir_Idl
	$(KEEP_GOING)@cd tests/MT_BiDir && $(MAKE) -f GNUmakefile.MT_BiDir_Server all

.PHONY: MT_BiDir_Client
MT_BiDir_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer BiDir_GIOP MT_BiDir_Idl MT_BiDir_Server
...
MT_Server_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer MT_Server_Idl
	$(KEEP_GOING)@cd tests/MT_Server && $(MAKE) -f GNUmakefile.MT_Server_Server all

.PHONY: MT_Server_Client
MT_Server_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode MT_Server_Idl MT_Server_Server
...
marshal_buffer_client: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer TAO_ETCL TAO_Monitor marshal_buffer_idl
	$(KEEP_GOING)@cd tests/Monitor/Marshal_Buffer && $(MAKE) -f GNUmakefile.marshal_buffer_client all

.PHONY: marshal_buffer_server
marshal_buffer_server: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer marshal_buffer_idl marshal_buffer_client
...
Multiple_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer Multiple_Idl
	$(KEEP_GOING)@cd tests/Multiple && $(MAKE) -f GNUmakefile.Multiple_Client all

.PHONY: Multiple_Server
Multiple_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer Multiple_Idl Multiple_Client
...
Muxed_GIOP_Versions_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode Muxed_GIOP_Versions_Idl
...
Muxed_GIOP_Versions_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer Muxed_GIOP_Versions_Idl Muxed_GIOP_Versions_Client
...
MT_Client_Test_Nested_Upcall_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer TAO_Utils MT_Client_Test_Nested_Upcall_Idl
...
MT_Client_Test_Nested_Upcall_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer TAO_Utils MT_Client_Test_Nested_Upcall_Idl MT_Client_Test_Nested_Upcall_Server
...
TT_Nested_Upcall_Initiator: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer TAO_Utils TT_Nested_Upcall_Server_Idl
...
TT_Nested_Upcall_Server_A: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer TAO_Utils TT_Nested_Upcall_Server_Idl TT_Nested_Upcall_Initiator
...
TT_Nested_Upcall_Server_B: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer TAO_Utils TT_Nested_Upcall_Server_Idl TT_Nested_Upcall_Initiator
...
Nested_Upcall_Crash_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging Nested_Upcall_Crash_Idl
...
Nested_Upcall_Crash_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging Nested_Upcall_Crash_Idl Nested_Upcall_Crash_Server
...
Nested_Upcall_Crash_Scavenger: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging Nested_Upcall_Crash_Idl Nested_Upcall_Crash_Server
...
No_Server_Connect_Test_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer No_Server_Connect_Test_Idl
...
No_Server_Connect_Test_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode No_Server_Connect_Test_Idl No_Server_Connect_Test_Server
...
OBV_Factory_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype PortableServer OBV_Factory_Idl
	$(KEEP_GOING)@cd tests/OBV/Factory && $(MAKE) -f GNUmakefile.OBV_Factory_Server all

.PHONY: OBV_Factory_Client
OBV_Factory_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype OBV_Factory_Idl OBV_Factory_Server
...
OBV_Forward_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype OBV_Forward_Idl
	$(KEEP_GOING)@cd tests/OBV/Forward && $(MAKE) -f GNUmakefile.OBV_Forward_Client all

.PHONY: OBV_Forward_Server
OBV_Forward_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype PortableServer OBV_Forward_Idl OBV_Forward_Client
...
Indirection_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype PortableServer Indirection_IDL
	$(KEEP_GOING)@cd tests/OBV/Indirection && $(MAKE) -f GNUmakefile.Indirection_Server all

.PHONY: Indirection_Client
Indirection_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype Indirection_IDL Indirection_Server
...
OBV_Truncatable_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype PortableServer OBV_Truncatable_Idl
	$(KEEP_GOING)@cd tests/OBV/Truncatable && $(MAKE) -f GNUmakefile.OBV_Truncatable_Server all

.PHONY: OBV_Truncatable_Client
OBV_Truncatable_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype OBV_Truncatable_Idl OBV_Truncatable_Server
...
Objref_Sequence_Test_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode Objref_Sequence_Test_Idl
...
Objref_Sequence_Test_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer Objref_Sequence_Test_Idl Objref_Sequence_Test_Client
...
OctetSeq_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode OctetSeq_Idl
	$(KEEP_GOING)@cd tests/OctetSeq && $(MAKE) -f GNUmakefile.OctetSeq_Client all

.PHONY: OctetSeq_OctetSeq
OctetSeq_OctetSeq: TAO_IDL_EXE TAO Codeset AnyTypeCode OctetSeq_Idl OctetSeq_Client
	$(KEEP_GOING)@cd tests/OctetSeq && $(MAKE) -f GNUmakefile.OctetSeq_OctetSeq all

.PHONY: OctetSeq_Server
OctetSeq_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer OctetSeq_Idl OctetSeq_Client
...
Ondemand_Write_Client: TAO_IDL_EXE TAO Codeset Ondemand_Write_Idl
	$(KEEP_GOING)@cd tests/Ondemand_Write && $(MAKE) -f GNUmakefile.Ondemand_Write_Client all

.PHONY: Ondemand_Write_Server
Ondemand_Write_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer Ondemand_Write_Idl Ondemand_Write_Client
...
Oneway_Buffering_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging Oneway_Buffering_Idl
	$(KEEP_GOING)@cd tests/Oneway_Buffering && $(MAKE) -f GNUmakefile.Oneway_Buffering_Server all

.PHONY: Oneway_Buffering_Admin
Oneway_Buffering_Admin: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging Oneway_Buffering_Idl Oneway_Buffering_Server
	$(KEEP_GOING)@cd tests/Oneway_Buffering && $(MAKE) -f GNUmakefile.Oneway_Buffering_Admin all

.PHONY: Oneway_Buffering_Client
Oneway_Buffering_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging Oneway_Buffering_Idl Oneway_Buffering_Server
...
Oneways_Invoking_Twoways_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer Oneways_Invoking_Twoways_Idl
...
Oneways_Invoking_Twoways_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer Oneways_Invoking_Twoways_Idl Oneways_Invoking_Twoways_Server
...
POA_DSI_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging DynamicInterface POA_DSI_IDL
	$(KEEP_GOING)@cd tests/POA/DSI && $(MAKE) -f GNUmakefile.POA_DSI_Server all

.PHONY: POA_DSI_Client
POA_DSI_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging POA_DSI_IDL POA_DSI_Server
...
POA_Forwarding_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode POA_Forwarding_IDL
	$(KEEP_GOING)@cd tests/POA/Forwarding && $(MAKE) -f GNUmakefile.POA_Forwarding_Client all

.PHONY: POA_Forwarding_Server
POA_Forwarding_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer POA_Forwarding_IDL POA_Forwarding_Client
...
Parallel_Connect_Strategy_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer IORTable Parallel_Connect_Strategy_Idl
...
Parallel_Connect_Strategy_Client: TAO_IDL_EXE TAO Codeset Parallel_Connect_Strategy_Idl Parallel_Connect_Strategy_Server
...
Param_Test_Anyop: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer Param_Test_Idl
	$(KEEP_GOING)@cd tests/Param_Test && $(MAKE) -f GNUmakefile.Param_Test_Anyop all

.PHONY: Param_Test_Client
Param_Test_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging DynamicInterface Param_Test_Idl Param_Test_Anyop
	$(KEEP_GOING)@cd tests/Param_Test && $(MAKE) -f GNUmakefile.Param_Test_Client all

.PHONY: Param_Test_Server
Param_Test_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer Param_Test_Idl Param_Test_Anyop
...
AdvSlot_Client: TAO_IDL_EXE TAO Codeset AdvSlot_Idl
	$(KEEP_GOING)@cd tests/Portable_Interceptors/AdvSlot && $(MAKE) -f GNUmakefile.AdvSlot_Client all

.PHONY: AdvSlot_Server
AdvSlot_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer PI_Server AdvSlot_Idl AdvSlot_Client
...
Bug_3080_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI Bug_3080_Idl
	$(KEEP_GOING)@cd tests/Portable_Interceptors/Bug_3080 && $(MAKE) -f GNUmakefile.Bug_3080_Client all

.PHONY: Bug_3080_Server
Bug_3080_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer Bug_3080_Idl Bug_3080_Client
...
PI_Dynamic_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer PI_Server PI_Dynamic_Idl
	$(KEEP_GOING)@cd tests/Portable_Interceptors/Dynamic && $(MAKE) -f GNUmakefile.PI_Dynamic_Server all

.PHONY: PI_Dynamic_Client
PI_Dynamic_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PI_Dynamic_Idl PI_Dynamic_Server
...
PI_IORInterceptor_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PI_IORInterceptor_Idl
...
PI_IORInterceptor_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer ObjRefTemplate IORInterceptor PI_IORInterceptor_Idl PI_IORInterceptor_Client
...
PI_ORB_Shutdown_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer PI_Server PI_ORB_Shutdown_Idl
...
PI_ORB_Shutdown_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode PI_ORB_Shutdown_Idl PI_ORB_Shutdown_Server
...
PI_PICurrent_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PI_PICurrent_Idl
	$(KEEP_GOING)@cd tests/Portable_Interceptors/PICurrent && $(MAKE) -f GNUmakefile.PI_PICurrent_Client all

.PHONY: PI_PICurrent_Server
PI_PICurrent_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer PI_Server PI_PICurrent_Idl PI_PICurrent_Client
...
RTCORBA_Banded_Conn_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer RTCORBA RTPortableServer RTCORBA_Banded_Conn_Idl
...
RTCORBA_Banded_Conn_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI RTCORBA RTCORBA_Banded_Conn_Idl RTCORBA_Banded_Conn_Server
...
RT_Dynamic_Thread_Pool_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer RTCORBA RTPortableServer Strategies RT_Dynamic_Thread_Pool_Idl
...
RT_Dynamic_Thread_Pool_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI RTCORBA Strategies RT_Dynamic_Thread_Pool_Idl RT_Dynamic_Thread_Pool_Server
...
RTCORBA_Policy_Combinations_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI RTCORBA RTCORBA_Policy_Combinations_Idl
...
RTCORBA_Policy_Combinations_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer RTCORBA RTPortableServer RTCORBA_Policy_Combinations_Idl RTCORBA_Policy_Combinations_Client
...
Priority_Inversion_With_Bands_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI RTCORBA Strategies Priority_Inversion_With_Bands_Idl
...
Priority_Inversion_With_Bands_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer RTCORBA RTPortableServer Strategies Priority_Inversion_With_Bands_Idl Priority_Inversion_With_Bands_Client
...
RTCORBA_Private_Connection_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI RTCORBA RTCORBA_Private_Connection_Idl
...
RTCORBA_Private_Connection_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer RTCORBA RTPortableServer RTCORBA_Private_Connection_Idl RTCORBA_Private_Connection_Client
...
RTCORBA_Server_Protocol_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI RTCORBA Strategies RTCORBA_Server_Protocol_Idl
...
RTCORBA_Server_Protocol_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer RTCORBA RTPortableServer Strategies RTCORBA_Server_Protocol_Idl RTCORBA_Server_Protocol_Client
...
RTCORBA_Thread_Pool_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI RTCORBA Strategies RTCORBA_Thread_Pool_Idl
...
RTCORBA_Thread_Pool_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode CodecFactory PI PortableServer RTCORBA RTPortableServer Strategies RTCORBA_Thread_Pool_Idl RTCORBA_Thread_Pool_Client
...
Reliable_Oneways_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging Reliable_Oneways_Idl
	$(KEEP_GOING)@cd tests/Reliable_Oneways && $(MAKE) -f GNUmakefile.Reliable_Oneways_Server all

.PHONY: Reliable_Oneways_Client
Reliable_Oneways_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging Reliable_Oneways_Idl Reliable_Oneways_Server
...
Sequence_Unit_Tests_B_Sequence_CDR: TAO_IDL_EXE TAO Codeset
...
Sequence_Unit_Tests_B_Obj_Ref_Seq: TAO_IDL_EXE TAO Codeset Sequence_Unit_Tests_B_Sequence_CDR
...
Sequence_Unit_Tests_Obj_Ref_Seq_Elem: TAO_IDL_EXE TAO Codeset Sequence_Unit_Tests_B_Sequence_CDR
...
Sequence_Unit_Tests_UB_Obj_Ref_Seq: TAO_IDL_EXE TAO Codeset Sequence_Unit_Tests_B_Sequence_CDR
...
Sequence_Unit_Tests_UB_Oct_Seq_No_Cpy: TAO_IDL_EXE TAO Codeset Sequence_Unit_Tests_B_Sequence_CDR
...
Sequence_Unit_Tests_UB_Octet_Sequence: TAO_IDL_EXE TAO Codeset Sequence_Unit_Tests_B_Sequence_CDR
...
Sequence_Unit_Tests_UB_Sequence_CDR: TAO_IDL_EXE TAO Codeset Sequence_Unit_Tests_B_Sequence_CDR
...
Server_Connection_Purging_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode Server_Connection_Purging_Idl
...
Server_Connection_Purging_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer Server_Connection_Purging_Idl Server_Connection_Purging_Client
...
Server_Connection_Purging_ShutCl: TAO_IDL_EXE TAO Codeset AnyTypeCode Server_Connection_Purging_Idl Server_Connection_Purging_Client
...
Server_Leaks_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer Server_Leaks_Idl
	$(KEEP_GOING)@cd tests/Server_Leaks && $(MAKE) -f GNUmakefile.Server_Leaks_Server all

.PHONY: Server_Leaks_Client
Server_Leaks_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode Server_Leaks_Idl Server_Leaks_Server
...
Single_Read_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode Single_Read_Idl
	$(KEEP_GOING)@cd tests/Single_Read && $(MAKE) -f GNUmakefile.Single_Read_Client all

.PHONY: Single_Read_Server
Single_Read_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer Single_Read_Idl Single_Read_Client
...
Smart_Proxies_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer SmartProxies Smart_Proxies_Idl
	$(KEEP_GOING)@cd tests/Smart_Proxies && $(MAKE) -f GNUmakefile.Smart_Proxies_Server all

.PHONY: Smart_Proxies_Client
Smart_Proxies_Client: TAO_IDL_EXE TAO Codeset SmartProxies Smart_Proxies_Idl Smart_Proxies_Server
...
.PHONY: Dtor_Client
Dtor_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode SmartProxies dtor_idl
	$(KEEP_GOING)@cd tests/Smart_Proxies/dtor && $(MAKE) -f GNUmakefile.Dtor_Client all

.PHONY: Dtor_Server
Dtor_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer SmartProxies dtor_idl Dtor_Client
...
Stack_Recursion_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode Stack_Recursion_Idl
	$(KEEP_GOING)@cd tests/Stack_Recursion && $(MAKE) -f GNUmakefile.Stack_Recursion_Client all

.PHONY: Stack_Recursion_Server
Stack_Recursion_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer Stack_Recursion_Idl Stack_Recursion_Client
...
Two_Objects_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode Two_Objects_Idl
	$(KEEP_GOING)@cd tests/Two_Objects && $(MAKE) -f GNUmakefile.Two_Objects_Client all

.PHONY: Two_Objects_Server
Two_Objects_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer Two_Objects_Idl Two_Objects_Client
...
typedef_string_array_server: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer typedef_string_array_idl
...
typedef_string_array_client: TAO_IDL_EXE TAO Codeset AnyTypeCode typedef_string_array_idl typedef_string_array_server
...
UNKNOWN_Exception_Server: TAO_IDL_EXE TAO Codeset AnyTypeCode PortableServer UNKNOWN_Exception_Idl
	$(KEEP_GOING)@cd tests/UNKNOWN_Exception && $(MAKE) -f GNUmakefile.UNKNOWN_Exception_Server all

.PHONY: UNKNOWN_Exception_Client
UNKNOWN_Exception_Client: TAO_IDL_EXE TAO Codeset AnyTypeCode UNKNOWN_Exception_Idl UNKNOWN_Exception_Server
...
.PHONY: catior
catior: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging RTCORBA CosNaming Compression ZIOP catior_lib
...
.PHONY: nsadd
nsadd: TAO_IDL_EXE TAO Codeset AnyTypeCode CosNaming
	$(KEEP_GOING)@cd utils/nslist && $(MAKE) -f GNUmakefile.nsadd all

.PHONY: nsdel
nsdel: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming Svc_Utils
	$(KEEP_GOING)@cd utils/nslist && $(MAKE) -f GNUmakefile.nsdel all

.PHONY: nslist
nslist: TAO_IDL_EXE TAO Codeset AnyTypeCode Valuetype CodecFactory PI PortableServer Messaging CosNaming Svc_Utils Strategies
...
project_name_list:
	...
	@echo DeadMemberDetection_App_Ctrl_Client
	@echo DeadMemberDetection_App_Ctrl_Idl
	@echo DeadMemberDetection_App_Ctrl_Server
