...
void LB_STDCALL lbJSONInputStream::visit(lb_I_Applications_Formulars* applicationformulars) {
	int count = 0;
	*iStream >> count;
...
void LB_STDCALL lbJSONInputStream::visit(lb_I_ReportParameters* reportparameters) {
	int count = 0;
	*iStream >> count;
...
void LB_STDCALL lbJSONInputStream::visit(lb_I_ReportElements* reportelements) {
	int count = 0;
	*iStream >> count;
...
void LB_STDCALL lbJSONInputStream::visit(lb_I_ReportElementTypes* reportelementtypes) {
	int count = 0;
	*iStream >> count;
...
void LB_STDCALL lbJSONInputStream::visit(lb_I_ReportTexts* reporttexts) {
	int count = 0;
	*iStream >> count;
...
void LB_STDCALL lbJSONInputStream::visit(lb_I_DBReportTextblock*) {

}

void LB_STDCALL lbJSONInputStream::visit(lb_I_DBReportProperties*) {

}

void LB_STDCALL lbJSONInputStream::visit(lb_I_UserAccounts* users) {
	// Number of users
	int   count = 0;
	*iStream >> count;
...
void LB_STDCALL lbJSONInputStream::visit(lb_I_DBTableParameter* dbtableparameter) {
	// Number of users
	int   count = 0;
	*iStream >> count;
...
void LB_STDCALL lbJSONInputStream::visit(lb_I_DBColumnParameter* dbcolumnparameter) {
	// Number of users
	int   count = 0;
	*iStream >> count;
...
void LB_STDCALL lbJSONInputStream::visit(lb_I_FormularFieldParameter* formularfieldparameter) {
	// Number of users
	int   count = 0;
	*iStream >> count;
