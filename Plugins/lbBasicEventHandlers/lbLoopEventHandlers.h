 ...
 */
class lbLoopEventHandlers: 
public lb_I_VisitableHelper,
public lb_I_EventHandler
{
public:
	lbLoopEventHandlers();
	virtual ~lbLoopEventHandlers();
	...
	lbErrCodes				LB_STDCALL loopContainer(lb_I_Unknown* uk);
	lbErrCodes				LB_STDCALL loopQueryResult(lb_I_Unknown* uk);
};
