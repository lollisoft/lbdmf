...
* $Revision: 1.91.2.7 $
* $Name:  $
* $Id: lbPluginManager.cpp,v 1.91.2.7 2025/04/12 10:09:26 lothar Exp $
*
* $Log: lbPluginManager.cpp,v $
* Revision 1.91.2.7  2025/04/12 10:09:26  lothar
...
* Completely implemented an UML based code generation workflow using UML Activitíes.
*
...
void LB_STDCALL lbPluginManager::initialize() {
        ...
        _CL_LOG << "Have plugin directory here: " << pluginDir LOG_
