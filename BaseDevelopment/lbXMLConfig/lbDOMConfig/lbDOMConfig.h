 ...
 * $Revision: 1.13.2.3 $
 * $Name:  $
 * $Id: lbDOMConfig.h,v 1.13.2.3 2025/04/12 10:54:06 lothar Exp $
 *
 * $Log: lbDOMConfig.h,v $
 * Revision 1.13.2.3  2025/04/12 10:54:06  lothar
 * Changed my address and copyright start and ending year to reflect
 * my upcoming new home and timeframe of development.
 *
 * Revision 1.13.2.2  2025/04/12 10:09:26  lothar
 * Changed my address and copyright start and ending year to reflect
 * my upcoming new home and timeframe of development.
 *
 * Revision 1.13.2.1  2025/04/05 16:16:30  lothar
