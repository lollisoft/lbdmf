...
{									  \
									  ...
									  \
CORBA::name::name (ULong minor, CompletionStatus status)		  \
    : CORBA::SystemException (minor, status)				  \
{									  \
}									  \
									  \
CORBA::name &								  \
...
{									  \
    MICO_SCOPE(CORBA,SystemException::operator=) (ex);			  \
    return *this;							  \
}									  \
									  \
CORBA::name::~name ()							  \
...
{									  \
    a <<= *this;							  \
									  ...
									  \
CORBA::name *								  \
CORBA::name::EXCEPTION_DOWNCAST (Exception *ex)				  \
{									  \
    ...
    return NULL;							  \
									  ...
									  \
const CORBA::name *							  \
CORBA::name::EXCEPTION_DOWNCAST (const Exception *ex)			  \
{									  \
    if (ex && !strcmp (ex->_repoid(), "IDL:omg.org/CORBA/" #name ":1.0")) \
