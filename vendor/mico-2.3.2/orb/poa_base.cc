...
PortableServer::_the_poa_current = PortableServer::Current::_nil();
#endif
...
{
  MICO_SCOPE(CORBA,DefaultValueRefCountBase)::_add_ref ();
}

void
PortableServer::ValueRefCountBase::_remove_ref ()
{
  MICO_SCOPE(CORBA,DefaultValueRefCountBase)::_remove_ref ();
}

CORBA::ULong
PortableServer::ValueRefCountBase::_refcount_value ()
{
  return MICO_SCOPE(CORBA,DefaultValueRefCountBase)::_refcount_value ();
}
...
{
  return MICO_SCOPE(PortableServer,ServantBase::_this) ();
}
...
#if 0
PortableServer::ServantBase_var::ServantBase_var ()
{
  _ptr = NULL;
}

PortableServer::ServantBase_var::ServantBase_var (ServantBase * serv)
{
  _ptr = serv;
}

PortableServer::ServantBase_var::ServantBase_var (const ServantBase_var & o)
{
  if ((_ptr = o._ptr) != NULL) {
    _ptr->_add_ref ();
  }
...
PortableServer::ServantBase_var::operator= (ServantBase * p)
{
  if (_ptr) {
    _ptr->_remove_ref ();
  }
...
PortableServer::ServantBase_var &
PortableServer::ServantBase_var::operator= (const ServantBase_var & o)
{
  if (_ptr != o._ptr) {
    if (_ptr) {
      _ptr->_remove_ref ();
...
PortableServer::ServantBase *
PortableServer::ServantBase_var::operator-> () const
{
  _ptr->_check ();
  return _ptr;
}
...
PortableServer::ServantBase *
PortableServer::ServantBase_var::in () const
{
  _ptr->_check ();
  return _ptr;
}
...
PortableServer::ServantBase *&
PortableServer::ServantBase_var::inout ()
{
  _ptr->_check ();
  return _ptr;
}
...
PortableServer::ServantBase *&
PortableServer::ServantBase_var::out ()
{
  return _ptr;
}

PortableServer::ServantBase *
PortableServer::ServantBase_var::_retn ()
{
  PortableServer::ServantBase * rv = _ptr;
  _ptr = NULL;
  rv->_check();
  return rv;
}
...
{
  _colocated_poa = MICO_SCOPE(PortableServer,POA::_duplicate) (poa);
}
...
PortableServer::StubBase::_preinvoke ()
{
  ...
  if (serv == NULL) {
    CORBA::release (_colocated_poa);
    _colocated_poa = MICO_SCOPE(PortableServer,POA::_nil) ();
    return NULL;
  }
...
PortableServer::ServantActivator_stub_clp::ServantActivator_stub_clp (PortableServer::POA_ptr poa, CORBA::Object_ptr obj)
  : MICO_SCOPE(PortableServer,StubBase) (poa), MICO_SCOPE(CORBA,Object) (*obj),
  MICO_SCOPE(PortableServer,ServantManager_stub_clp) (poa, obj)
{
}
...
POA_PortableServer::ServantActivator::_is_a (const char * repoid)
{
  ...
  if (MICO_SCOPE(POA_PortableServer,ServantManager)::_is_a (repoid)) {
    return TRUE;
  }
  return FALSE;
}
...
POA_PortableServer::ServantActivator::_narrow_helper (const char * repoid)
{
  ...
  if ((p = MICO_SCOPE(POA_PortableServer,ServantManager)::_narrow_helper (repoid)) != NULL) {
    return p;
  }
  return NULL;
}
