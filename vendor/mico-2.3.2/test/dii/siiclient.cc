...
CORBA::Long
add_stub (CORBA::Object_ptr obj, CORBA::Long x, CORBA::Long y, char *&str,
...
SF
fixed_stub (CORBA::Object_ptr obj, const SF &in, SF &inout, SF &out)
{
...
SV *
variable_stub (CORBA::Object_ptr obj, const SV &in, SV &inout, SV *&out)
{
